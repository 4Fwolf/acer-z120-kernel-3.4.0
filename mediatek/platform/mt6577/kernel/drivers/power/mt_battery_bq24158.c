...
#if defined(ACER_Z1) || defined(ACER_Z2) || defined(ACER_Z3)
...
#if defined(ACER_Z1) || defined(ACER_Z2) || defined(ACER_Z3) //for Acer charger test
...
int CHARGING_FULL_CURRENT=160;    // mA
#else
...
#if defined(ACER_Z1) || defined(ACER_Z2) || defined(ACER_Z3)  //for C8 charger test
...
int g_Get_I_Charging(void)
{
    ...
    {
	#if 1//defined(PHILIPS_CASTEL)
		ICharging = (ADC_I_SENSE - ADC_BAT_SENSE)*1000/R_CURRENT_SENSE;  //R=0.068 Ohm
	#else
...
void mt_battery_notify_check(void)
{
    ...
    #if defined(ACER_Z1) || defined(ACER_Z2) || defined(ACER_Z3)//battery capcity is 1300mA, no larger than 1300mA
...
int gpio_number   = GPIO_SWCHARGER_EN_PIN;//GPIO70
...
void bq24158_set_ac_current(void)
{
    ...
    bq24158_config_interface_reg(0x01,0xF8);
    bq24158_config_interface_reg(0x02,0x8E);
    bq24158_config_interface_reg(0x04,0x4a); //set IOCHARGE /punk 19->72 4a(900mA)
    bq24158_config_interface_reg(0x05,0x04);
#endif
    ...
    {    
        if ( BMT_status.charger_type == STANDARD_HOST ) 
        {
            ...
            {    
                ...
                bq24158_config_interface_reg(0x01,0x78);
#if 1//defined(PHILIPS_CASTEL)
				bq24158_config_interface_reg(0x04,0x0a); //set IOCHARGE to 550mA for USB charge
#else
