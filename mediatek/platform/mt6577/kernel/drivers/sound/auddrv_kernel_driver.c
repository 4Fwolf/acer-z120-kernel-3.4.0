      ...
      case YUSU_INFO_FROM_USER:
      {
         ...
         switch(InfoData.info) {
           ...
           case INFO_U2K_MATV_AUDIO_STOP:
              ...
              break;
           case INFO_U2K_DPIDLE_I2S0:
              if(InfoData.param1 == 1)
              {
                 disable_dpidle_by_bit(MT65XX_PDN_AUDIO_I2S); 
              }
              else if(InfoData.param1 == 0)
              {                
                 enable_dpidle_by_bit(MT65XX_PDN_AUDIO_I2S); 
              }
              break;
           default:
              break;
