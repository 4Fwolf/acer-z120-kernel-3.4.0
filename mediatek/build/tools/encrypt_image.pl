...
my @imgs_need_enc = ("boot.img", "logo.bin", "recovery.img", "secro.img", "system.img", "uboot_${prj}.bin", "userdata.img", "lk.bin");
...
my @imgs_need_enc = ("boot-sign.img", "logo-sign.bin", "recovery-sign.img", "secro-sign.img", "system-sign.img", "uboot_${prj}-sign.bin", "userdata-sign.img", "lk-sign.bin");
