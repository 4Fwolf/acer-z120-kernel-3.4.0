...
#define MAX_CHARGE_NOTIFY_TEMPERATURE  55
#define MIN_CHARGE_NOTIFY_TEMPERATURE  -10
...
#else
#define AC_CHARGER_CURRENT					Cust_CC_550MA //LK@ 700->550 for default	
#endif
...
#define V_CHARGER_MIN 4300				// 4.4 V //LK@4.4->4.3
...
#define TBAT_OVER_CRITICAL_LOW     68237 //LK@set this default value

//#define TBAT_OVER_CRITICAL_LOW     483954



#define BAT_TEMP_PROTECT_ENABLE    1 //LK@open temp protect function
...
#if defined(ACER_Z1) || defined(ACER_Z2)//for low temperature warning
