...
{
#ifdef BUILD_LK
	printf("init_lcm_registers -----txd350nh_hvga_ili9487 \r\n");
#else
	printk("init_lcm_registers-----txd350nh_hvga_ili9487  \r\n");
#endif
	...
	send_ctrl_cmd(0xC0); 
	send_data_cmd(0x0f); //10
	send_data_cmd(0x0f); //10
	 
	send_ctrl_cmd(0xC1); 
	send_data_cmd(0x45); //44
	...
	send_data_cmd(0x0b); 
	send_data_cmd(0x07); 
	send_data_cmd(0x4b); //44
	send_data_cmd(0x86); 
	send_data_cmd(0x3e); 
	send_data_cmd(0x08); 
	send_data_cmd(0x13); //08
	send_data_cmd(0x05); 
	send_data_cmd(0x18); 
	send_data_cmd(0x18); 
	send_data_cmd(0x00);  
	...
	send_data_cmd(0x33); 
	send_data_cmd(0x0b); 
	send_data_cmd(0x0d);//27 
	send_data_cmd(0x03); 
	send_data_cmd(0x4c); 
	send_data_cmd(0x42); 
	send_data_cmd(0x39); //37
	send_data_cmd(0x05); 
	send_data_cmd(0x0e); 
	send_data_cmd(0x04); 
	send_data_cmd(0x24); 
...
// ---------------------------------------------------------------------------
LCM_DRIVER txd350nh_hvga_ili9487_lcm_drv = 
{
    .name			= "txd350nh_ili9487",
