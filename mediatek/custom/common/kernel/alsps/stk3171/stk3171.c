...
static stk3171_WriteCalibration(struct PS_CALI_DATA_STRUCT *data_cali)
{
...
/************************maliyan add 2012-11-12 start*************************************/
		...
		case ALSPS_GET_PS_THD:    //ps_threshold
			...
			{
				ps_cali_temp.close=atomic_read(&obj->ps_threshold_high);
				ps_cali_temp.far_away=atomic_read(&obj->ps_threshold_low);
			...
			stk3171_WriteCalibration(&ps_cali_temp);
printk("[LONG][ALS/PS] ALSPS_SET_PS_CALI %d,%d,%d\n\r",ps_cali_temp.close,ps_cali_temp.far_away,ps_cali_temp.valid);
			stk3171_write_ps_high_thd(client, atomic_read(&obj->ps_threshold_high));
                        stk3171_write_ps_low_thd(client, atomic_read(&obj->ps_threshold_low));
/************************maliyan add 2012-11-12 end*************************************/
		default:
