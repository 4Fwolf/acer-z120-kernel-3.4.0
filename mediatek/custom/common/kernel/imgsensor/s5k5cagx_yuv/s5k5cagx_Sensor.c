...
static kal_uint16 S5K5CAGX_current_awb =AWB_MODE_AUTO;
//===============old============================================
...
S5K5CAGX_write_cmos_sensor(0x0014, 0x0001);   //Wait100mSec                            //
       ...
       mdelay(15); //p100  //ffff0064  //Delay 100ms
...
S5K5CAGX_write_cmos_sensor(0x0F12, 0x0155);//set IO driving current 2mA for Gs500
S5K5CAGX_write_cmos_sensor(0x0F12, 0x0155);//set IO driving current
S5K5CAGX_write_cmos_sensor(0x0F12, 0x1555);//set IO driving current
S5K5CAGX_write_cmos_sensor(0x0F12, 0x05D5);//set IO driving current
...
S5K5CAGX_write_cmos_sensor(0x0F12, 0xEAF0);             //#gisp_dadlc_config
S5K5CAGX_write_cmos_sensor(0x002A, 0x15C6);
S5K5CAGX_write_cmos_sensor(0x0F12, 0x0020);             //#gisp_dcdstat_LeftColW88
S5K5CAGX_write_cmos_sensor(0x0F12, 0x0060);             // #gisp_dcdstat_RightColW88
S5K5CAGX_write_cmos_sensor(0x002A, 0x15BC);
S5K5CAGX_write_cmos_sensor(0x0F12, 0x0200);             //gisp_dcdstat_Pedestal            // added by Shy.
...
S5K5CAGX_write_cmos_sensor(0x0F12, 0x3415);   //3A98 //3A98////lt_uMaxExp132 30ms  9~10ea// 15fps  // 
S5K5CAGX_write_cmos_sensor(0x002A, 0x0534);                                                               
S5K5CAGX_write_cmos_sensor(0x0F12, 0x682A);   //68b0 //7EF4////lt_uMaxExp267 65ms18~20ea // 7.5fps //
S5K5CAGX_write_cmos_sensor(0x002A, 0x167C);                                                               
S5K5CAGX_write_cmos_sensor(0x0F12, 0x8235);   //8340 //9C40//MaxExp3  83 80ms  24~25ea //                 
S5K5CAGX_write_cmos_sensor(0x002A, 0x1680);                                                               
S5K5CAGX_write_cmos_sensor(0x0F12, 0xc350);    //F424//MaxExp4   125ms  38ea //                           
...
S5K5CAGX_write_cmos_sensor(0x0F12, 0x0150);   //01B3   //0200//0400//lt_uMaxAnGain2_400lux//                              
...
S5K5CAGX_write_cmos_sensor(0x0F12, 0x0001);   //expand forbidde zone //                                   

S5K5CAGX_write_cmos_sensor(0x002A, 0x021A);                                                               
S5K5CAGX_write_cmos_sensor(0x0F12, 0x0000);  //MBR off//                                                     
    ...
    //Anti-Shading
    //============================================================
    //param_startTVAR_ash_GASAlpha
S5K5CAGX_write_cmos_sensor(0x0028, 0x7000);
S5K5CAGX_write_cmos_sensor(0x002A, 0x06CE);
S5K5CAGX_write_cmos_sensor(0x0F12, 0x00D0);            //TVAR_ash_GASAlpha[0]
S5K5CAGX_write_cmos_sensor(0x0F12, 0x00E0);            //TVAR_ash_GASAlpha[1]
S5K5CAGX_write_cmos_sensor(0x0F12, 0x00F0);            //TVAR_ash_GASAlpha[2]
S5K5CAGX_write_cmos_sensor(0x0F12, 0x00FE);            //TVAR_ash_GASAlpha[3]
S5K5CAGX_write_cmos_sensor(0x0F12, 0x00B0);            //TVAR_ash_GASAlpha[4]
S5K5CAGX_write_cmos_sensor(0x0F12, 0x00E0);            //TVAR_ash_GASAlpha[5]
S5K5CAGX_write_cmos_sensor(0x0F12, 0x00C0);            //TVAR_ash_GASAlpha[6]
S5K5CAGX_write_cmos_sensor(0x0F12, 0x00E0);            //TVAR_ash_GASAlpha[7]
S5K5CAGX_write_cmos_sensor(0x0F12, 0x00C0);            //TVAR_ash_GASAlpha[8]
S5K5CAGX_write_cmos_sensor(0x0F12, 0x00A0);            //TVAR_ash_GASAlpha[9]
S5K5CAGX_write_cmos_sensor(0x0F12, 0x00A0);            //TVAR_ash_GASAlpha[10]
S5K5CAGX_write_cmos_sensor(0x0F12, 0x00B0);            //TVAR_ash_GASAlpha[11]
S5K5CAGX_write_cmos_sensor(0x0F12, 0x00CD);            //TVAR_ash_GASAlpha[12]
S5K5CAGX_write_cmos_sensor(0x0F12, 0x00F1);            //TVAR_ash_GASAlpha[13]
S5K5CAGX_write_cmos_sensor(0x0F12, 0x00F3);            //TVAR_ash_GASAlpha[14]
S5K5CAGX_write_cmos_sensor(0x0F12, 0x00E5);            //TVAR_ash_GASAlpha[15]
S5K5CAGX_write_cmos_sensor(0x0F12, 0x00CC);            //TVAR_ash_GASAlpha[16]
S5K5CAGX_write_cmos_sensor(0x0F12, 0x00E2);            //TVAR_ash_GASAlpha[17]
S5K5CAGX_write_cmos_sensor(0x0F12, 0x00E1);            //TVAR_ash_GASAlpha[18]
S5K5CAGX_write_cmos_sensor(0x0F12, 0x00E3);            //TVAR_ash_GASAlpha[19]
S5K5CAGX_write_cmos_sensor(0x0F12, 0x00B0);             //TVAR_ash_GASAlpha[20]
S5K5CAGX_write_cmos_sensor(0x0F12, 0x00D2);            //TVAR_ash_GASAlpha[21]
S5K5CAGX_write_cmos_sensor(0x0F12, 0x00CF);            //TVAR_ash_GASAlpha[22]
S5K5CAGX_write_cmos_sensor(0x0F12, 0x00E1);            //TVAR_ash_GASAlpha[23]
S5K5CAGX_write_cmos_sensor(0x0F12, 0x00CB);            //TVAR_ash_GASAlpha[24]
S5K5CAGX_write_cmos_sensor(0x0F12, 0x00D2);            //TVAR_ash_GASAlpha[25]
S5K5CAGX_write_cmos_sensor(0x0F12, 0x00CF);            //TVAR_ash_GASAlpha[26]
S5K5CAGX_write_cmos_sensor(0x0F12, 0x00E1);            //TVAR_ash_GASAlpha[27]
                                                              //param_endTVAR_ash_GASAlpha
                                                              //param_startTVAR_ash_GASOutdoorAlpha
S5K5CAGX_write_cmos_sensor(0x002A, 0x0706);
S5K5CAGX_write_cmos_sensor(0x0F12, 0x00CB);            //TVAR_ash_GASOutdoorAlpha[0]
S5K5CAGX_write_cmos_sensor(0x0F12, 0x00D2);            //TVAR_ash_GASOutdoorAlpha[1]
S5K5CAGX_write_cmos_sensor(0x0F12, 0x00CF);            //TVAR_ash_GASOutdoorAlpha[2]
S5K5CAGX_write_cmos_sensor(0x0F12, 0x00E1);            //TVAR_ash_GASOutdoorAlpha[3]
                                                              //param_endTVAR_ash_GASOutdoorAlpha
                                                              //param_startash_GASBeta
S5K5CAGX_write_cmos_sensor(0x002A, 0x070E);
S5K5CAGX_write_cmos_sensor(0x0F12, 0x0060);            //ash_GASBeta[0]
S5K5CAGX_write_cmos_sensor(0x0F12, 0x002B);            //ash_GASBeta[1]
S5K5CAGX_write_cmos_sensor(0x0F12, 0x002F);            //ash_GASBeta[2]
S5K5CAGX_write_cmos_sensor(0x0F12, 0x0000);            //ash_GASBeta[3]
S5K5CAGX_write_cmos_sensor(0x0F12, 0x0052);            //ash_GASBeta[4]
S5K5CAGX_write_cmos_sensor(0x0F12, 0x0026);            //ash_GASBeta[5]
S5K5CAGX_write_cmos_sensor(0x0F12, 0x0029);            //ash_GASBeta[6]
S5K5CAGX_write_cmos_sensor(0x0F12, 0x0000);            //ash_GASBeta[7]
S5K5CAGX_write_cmos_sensor(0x0F12, 0x0010);            //ash_GASBeta[8]
S5K5CAGX_write_cmos_sensor(0x0F12, 0x0026);            //ash_GASBeta[9]
S5K5CAGX_write_cmos_sensor(0x0F12, 0x0028);            //ash_GASBeta[10]
S5K5CAGX_write_cmos_sensor(0x0F12, 0x0000);            //ash_GASBeta[11]
S5K5CAGX_write_cmos_sensor(0x0F12, 0x0010);            //ash_GASBeta[12]
S5K5CAGX_write_cmos_sensor(0x0F12, 0x0026);            //ash_GASBeta[13]
S5K5CAGX_write_cmos_sensor(0x0F12, 0x0027);            //ash_GASBeta[14]
S5K5CAGX_write_cmos_sensor(0x0F12, 0x0000);            //ash_GASBeta[15]
S5K5CAGX_write_cmos_sensor(0x0F12, 0x0023);            //ash_GASBeta[16]
S5K5CAGX_write_cmos_sensor(0x0F12, 0x001F);            //ash_GASBeta[17]
S5K5CAGX_write_cmos_sensor(0x0F12, 0x001F);            //ash_GASBeta[18]
S5K5CAGX_write_cmos_sensor(0x0F12, 0x0000);            //ash_GASBeta[19]
S5K5CAGX_write_cmos_sensor(0x0F12, 0x0025);            //ash_GASBeta[20]
S5K5CAGX_write_cmos_sensor(0x0F12, 0x0017);            //ash_GASBeta[21]
S5K5CAGX_write_cmos_sensor(0x0F12, 0x0016);            //ash_GASBeta[22]
S5K5CAGX_write_cmos_sensor(0x0F12, 0x0000);            //ash_GASBeta[23]
S5K5CAGX_write_cmos_sensor(0x0F12, 0x0025);            //ash_GASBeta[24]
S5K5CAGX_write_cmos_sensor(0x0F12, 0x0017);            //ash_GASBeta[25]
S5K5CAGX_write_cmos_sensor(0x0F12, 0x0016);            //ash_GASBeta[26]
S5K5CAGX_write_cmos_sensor(0x0F12, 0x0000);            //ash_GASBeta[27]
                                                         //param_endash_GASBeta
                                                         //param_startash_GASOutdoorBeta
S5K5CAGX_write_cmos_sensor(0x002A, 0x0746);
S5K5CAGX_write_cmos_sensor(0x0F12, 0x0025);            //ash_GASOutdoorBeta[0]
S5K5CAGX_write_cmos_sensor(0x0F12, 0x0017);            //ash_GASOutdoorBeta[1]
S5K5CAGX_write_cmos_sensor(0x0F12, 0x0016);            //ash_GASOutdoorBeta[2]
S5K5CAGX_write_cmos_sensor(0x0F12, 0x0000);            //ash_GASOutdoorBeta[3]
                                                           //param_endash_GASOutdoorBeta
...
S5K5CAGX_write_cmos_sensor(0x0F12, 0x0011);            //ash_uParabolicScalingB
                                                              //param_startTVAR_ash_pGAS
S5K5CAGX_write_cmos_sensor(0x002A, 0x347C);
S5K5CAGX_write_cmos_sensor(0x0F12, 0x0193);            //TVAR_ash_pGAS[0]
S5K5CAGX_write_cmos_sensor(0x0F12, 0x015F);            //TVAR_ash_pGAS[1]
S5K5CAGX_write_cmos_sensor(0x0F12, 0x0123);            //TVAR_ash_pGAS[2]
S5K5CAGX_write_cmos_sensor(0x0F12, 0x00F2);            //TVAR_ash_pGAS[3]
S5K5CAGX_write_cmos_sensor(0x0F12, 0x00D1);            //TVAR_ash_pGAS[4]
S5K5CAGX_write_cmos_sensor(0x0F12, 0x00BD);            //TVAR_ash_pGAS[5]
S5K5CAGX_write_cmos_sensor(0x0F12, 0x00B5);            //TVAR_ash_pGAS[6]
S5K5CAGX_write_cmos_sensor(0x0F12, 0x00B9);            //TVAR_ash_pGAS[7]
S5K5CAGX_write_cmos_sensor(0x0F12, 0x00CD);            //TVAR_ash_pGAS[8]
S5K5CAGX_write_cmos_sensor(0x0F12, 0x00EE);            //TVAR_ash_pGAS[9]
S5K5CAGX_write_cmos_sensor(0x0F12, 0x0121);            //TVAR_ash_pGAS[10]
S5K5CAGX_write_cmos_sensor(0x0F12, 0x015D);            //TVAR_ash_pGAS[11]
S5K5CAGX_write_cmos_sensor(0x0F12, 0x0197);            //TVAR_ash_pGAS[12]
S5K5CAGX_write_cmos_sensor(0x0F12, 0x016E);            //TVAR_ash_pGAS[13]
S5K5CAGX_write_cmos_sensor(0x0F12, 0x0133);            //TVAR_ash_pGAS[14]
S5K5CAGX_write_cmos_sensor(0x0F12, 0x00F0);            //TVAR_ash_pGAS[15]
S5K5CAGX_write_cmos_sensor(0x0F12, 0x00BE);            //TVAR_ash_pGAS[16]
S5K5CAGX_write_cmos_sensor(0x0F12, 0x0097);            //TVAR_ash_pGAS[17]
S5K5CAGX_write_cmos_sensor(0x0F12, 0x0081);            //TVAR_ash_pGAS[18]
S5K5CAGX_write_cmos_sensor(0x0F12, 0x007C);            //TVAR_ash_pGAS[19]
S5K5CAGX_write_cmos_sensor(0x0F12, 0x0081);            //TVAR_ash_pGAS[20]
S5K5CAGX_write_cmos_sensor(0x0F12, 0x0096);            //TVAR_ash_pGAS[21]
S5K5CAGX_write_cmos_sensor(0x0F12, 0x00BC);            //TVAR_ash_pGAS[22]
S5K5CAGX_write_cmos_sensor(0x0F12, 0x00F2);            //TVAR_ash_pGAS[23]
S5K5CAGX_write_cmos_sensor(0x0F12, 0x0139);            //TVAR_ash_pGAS[24]
S5K5CAGX_write_cmos_sensor(0x0F12, 0x0171);            //TVAR_ash_pGAS[25]
S5K5CAGX_write_cmos_sensor(0x0F12, 0x0146);            //TVAR_ash_pGAS[26]
S5K5CAGX_write_cmos_sensor(0x0F12, 0x0106);            //TVAR_ash_pGAS[27]
S5K5CAGX_write_cmos_sensor(0x0F12, 0x00BF);            //TVAR_ash_pGAS[28]
S5K5CAGX_write_cmos_sensor(0x0F12, 0x0088);            //TVAR_ash_pGAS[29]
S5K5CAGX_write_cmos_sensor(0x0F12, 0x0060);            //TVAR_ash_pGAS[30]
S5K5CAGX_write_cmos_sensor(0x0F12, 0x0049);            //TVAR_ash_pGAS[31]
S5K5CAGX_write_cmos_sensor(0x0F12, 0x0042);            //TVAR_ash_pGAS[32]
S5K5CAGX_write_cmos_sensor(0x0F12, 0x0049);            //TVAR_ash_pGAS[33]
S5K5CAGX_write_cmos_sensor(0x0F12, 0x0061);            //TVAR_ash_pGAS[34]
S5K5CAGX_write_cmos_sensor(0x0F12, 0x008B);            //TVAR_ash_pGAS[35]
S5K5CAGX_write_cmos_sensor(0x0F12, 0x00C5);            //TVAR_ash_pGAS[36]
S5K5CAGX_write_cmos_sensor(0x0F12, 0x010F);            //TVAR_ash_pGAS[37]
S5K5CAGX_write_cmos_sensor(0x0F12, 0x0154);            //TVAR_ash_pGAS[38]
S5K5CAGX_write_cmos_sensor(0x0F12, 0x0124);            //TVAR_ash_pGAS[39]
S5K5CAGX_write_cmos_sensor(0x0F12, 0x00E1);            //TVAR_ash_pGAS[40]
S5K5CAGX_write_cmos_sensor(0x0F12, 0x009B);            //TVAR_ash_pGAS[41]
S5K5CAGX_write_cmos_sensor(0x0F12, 0x0062);            //TVAR_ash_pGAS[42]
S5K5CAGX_write_cmos_sensor(0x0F12, 0x0038);            //TVAR_ash_pGAS[43]
S5K5CAGX_write_cmos_sensor(0x0F12, 0x0021);            //TVAR_ash_pGAS[44]
S5K5CAGX_write_cmos_sensor(0x0F12, 0x0019);            //TVAR_ash_pGAS[45]
S5K5CAGX_write_cmos_sensor(0x0F12, 0x0023);            //TVAR_ash_pGAS[46]
S5K5CAGX_write_cmos_sensor(0x0F12, 0x003E);            //TVAR_ash_pGAS[47]
S5K5CAGX_write_cmos_sensor(0x0F12, 0x0069);            //TVAR_ash_pGAS[48]
S5K5CAGX_write_cmos_sensor(0x0F12, 0x00A6);            //TVAR_ash_pGAS[49]
S5K5CAGX_write_cmos_sensor(0x0F12, 0x00F5);            //TVAR_ash_pGAS[50]
S5K5CAGX_write_cmos_sensor(0x0F12, 0x013F);            //TVAR_ash_pGAS[51]
S5K5CAGX_write_cmos_sensor(0x0F12, 0x0117);            //TVAR_ash_pGAS[52]
S5K5CAGX_write_cmos_sensor(0x0F12, 0x00D0);            //TVAR_ash_pGAS[53]
S5K5CAGX_write_cmos_sensor(0x0F12, 0x0088);            //TVAR_ash_pGAS[54]
S5K5CAGX_write_cmos_sensor(0x0F12, 0x004C);            //TVAR_ash_pGAS[55]
S5K5CAGX_write_cmos_sensor(0x0F12, 0x0021);            //TVAR_ash_pGAS[56]
S5K5CAGX_write_cmos_sensor(0x0F12, 0x000A);            //TVAR_ash_pGAS[57]
S5K5CAGX_write_cmos_sensor(0x0F12, 0x0003);            //TVAR_ash_pGAS[58]
S5K5CAGX_write_cmos_sensor(0x0F12, 0x000E);            //TVAR_ash_pGAS[59]
S5K5CAGX_write_cmos_sensor(0x0F12, 0x002A);            //TVAR_ash_pGAS[60]
S5K5CAGX_write_cmos_sensor(0x0F12, 0x0058);            //TVAR_ash_pGAS[61]
S5K5CAGX_write_cmos_sensor(0x0F12, 0x0096);            //TVAR_ash_pGAS[62]
S5K5CAGX_write_cmos_sensor(0x0F12, 0x00E6);            //TVAR_ash_pGAS[63]
S5K5CAGX_write_cmos_sensor(0x0F12, 0x0135);            //TVAR_ash_pGAS[64]
S5K5CAGX_write_cmos_sensor(0x0F12, 0x0119);            //TVAR_ash_pGAS[65]
S5K5CAGX_write_cmos_sensor(0x0F12, 0x00CF);            //TVAR_ash_pGAS[66]
S5K5CAGX_write_cmos_sensor(0x0F12, 0x0085);            //TVAR_ash_pGAS[67]
S5K5CAGX_write_cmos_sensor(0x0F12, 0x0049);            //TVAR_ash_pGAS[68]
S5K5CAGX_write_cmos_sensor(0x0F12, 0x001E);            //TVAR_ash_pGAS[69]
S5K5CAGX_write_cmos_sensor(0x0F12, 0x0006);            //TVAR_ash_pGAS[70]
S5K5CAGX_write_cmos_sensor(0x0F12, 0x0000);            //TVAR_ash_pGAS[71]
S5K5CAGX_write_cmos_sensor(0x0F12, 0x000B);            //TVAR_ash_pGAS[72]
S5K5CAGX_write_cmos_sensor(0x0F12, 0x0028);            //TVAR_ash_pGAS[73]
S5K5CAGX_write_cmos_sensor(0x0F12, 0x0057);            //TVAR_ash_pGAS[74]
S5K5CAGX_write_cmos_sensor(0x0F12, 0x0097);            //TVAR_ash_pGAS[75]
S5K5CAGX_write_cmos_sensor(0x0F12, 0x00E9);            //TVAR_ash_pGAS[76]
S5K5CAGX_write_cmos_sensor(0x0F12, 0x013B);            //TVAR_ash_pGAS[77]
S5K5CAGX_write_cmos_sensor(0x0F12, 0x0127);            //TVAR_ash_pGAS[78]
S5K5CAGX_write_cmos_sensor(0x0F12, 0x00E0);            //TVAR_ash_pGAS[79]
S5K5CAGX_write_cmos_sensor(0x0F12, 0x0095);            //TVAR_ash_pGAS[80]
S5K5CAGX_write_cmos_sensor(0x0F12, 0x005A);            //TVAR_ash_pGAS[81]
S5K5CAGX_write_cmos_sensor(0x0F12, 0x002D);            //TVAR_ash_pGAS[82]
S5K5CAGX_write_cmos_sensor(0x0F12, 0x0015);            //TVAR_ash_pGAS[83]
S5K5CAGX_write_cmos_sensor(0x0F12, 0x0010);            //TVAR_ash_pGAS[84]
S5K5CAGX_write_cmos_sensor(0x0F12, 0x001A);            //TVAR_ash_pGAS[85]
S5K5CAGX_write_cmos_sensor(0x0F12, 0x0038);            //TVAR_ash_pGAS[86]
S5K5CAGX_write_cmos_sensor(0x0F12, 0x0069);            //TVAR_ash_pGAS[87]
S5K5CAGX_write_cmos_sensor(0x0F12, 0x00A9);            //TVAR_ash_pGAS[88]
S5K5CAGX_write_cmos_sensor(0x0F12, 0x00F9);            //TVAR_ash_pGAS[89]
S5K5CAGX_write_cmos_sensor(0x0F12, 0x014F);            //TVAR_ash_pGAS[90]
S5K5CAGX_write_cmos_sensor(0x0F12, 0x0142);            //TVAR_ash_pGAS[91]
S5K5CAGX_write_cmos_sensor(0x0F12, 0x00FE);            //TVAR_ash_pGAS[92]
S5K5CAGX_write_cmos_sensor(0x0F12, 0x00B7);            //TVAR_ash_pGAS[93]
S5K5CAGX_write_cmos_sensor(0x0F12, 0x007B);            //TVAR_ash_pGAS[94]
S5K5CAGX_write_cmos_sensor(0x0F12, 0x004E);            //TVAR_ash_pGAS[95]
S5K5CAGX_write_cmos_sensor(0x0F12, 0x0036);            //TVAR_ash_pGAS[96]
S5K5CAGX_write_cmos_sensor(0x0F12, 0x0030);            //TVAR_ash_pGAS[97]
S5K5CAGX_write_cmos_sensor(0x0F12, 0x003C);            //TVAR_ash_pGAS[98]
S5K5CAGX_write_cmos_sensor(0x0F12, 0x005A);            //TVAR_ash_pGAS[99]
S5K5CAGX_write_cmos_sensor(0x0F12, 0x008D);            //TVAR_ash_pGAS[100]
S5K5CAGX_write_cmos_sensor(0x0F12, 0x00CD);            //TVAR_ash_pGAS[101]
S5K5CAGX_write_cmos_sensor(0x0F12, 0x011A);            //TVAR_ash_pGAS[102]
S5K5CAGX_write_cmos_sensor(0x0F12, 0x016C);            //TVAR_ash_pGAS[103]
S5K5CAGX_write_cmos_sensor(0x0F12, 0x016B);            //TVAR_ash_pGAS[104]
S5K5CAGX_write_cmos_sensor(0x0F12, 0x012A);            //TVAR_ash_pGAS[105]
S5K5CAGX_write_cmos_sensor(0x0F12, 0x00E5);            //TVAR_ash_pGAS[106]
S5K5CAGX_write_cmos_sensor(0x0F12, 0x00AB);            //TVAR_ash_pGAS[107]
S5K5CAGX_write_cmos_sensor(0x0F12, 0x0082);            //TVAR_ash_pGAS[108]
S5K5CAGX_write_cmos_sensor(0x0F12, 0x006B);            //TVAR_ash_pGAS[109]
S5K5CAGX_write_cmos_sensor(0x0F12, 0x0064);            //TVAR_ash_pGAS[110]
S5K5CAGX_write_cmos_sensor(0x0F12, 0x0071);            //TVAR_ash_pGAS[111]
S5K5CAGX_write_cmos_sensor(0x0F12, 0x0090);            //TVAR_ash_pGAS[112]
S5K5CAGX_write_cmos_sensor(0x0F12, 0x00C0);            //TVAR_ash_pGAS[113]
S5K5CAGX_write_cmos_sensor(0x0F12, 0x00FF);            //TVAR_ash_pGAS[114]
S5K5CAGX_write_cmos_sensor(0x0F12, 0x014B);            //TVAR_ash_pGAS[115]
S5K5CAGX_write_cmos_sensor(0x0F12, 0x0192);            //TVAR_ash_pGAS[116]
S5K5CAGX_write_cmos_sensor(0x0F12, 0x019A);            //TVAR_ash_pGAS[117]
S5K5CAGX_write_cmos_sensor(0x0F12, 0x016A);            //TVAR_ash_pGAS[118]
S5K5CAGX_write_cmos_sensor(0x0F12, 0x0127);            //TVAR_ash_pGAS[119]
S5K5CAGX_write_cmos_sensor(0x0F12, 0x00EF);            //TVAR_ash_pGAS[120]
S5K5CAGX_write_cmos_sensor(0x0F12, 0x00CC);            //TVAR_ash_pGAS[121]
S5K5CAGX_write_cmos_sensor(0x0F12, 0x00B6);            //TVAR_ash_pGAS[122]
S5K5CAGX_write_cmos_sensor(0x0F12, 0x00B2);            //TVAR_ash_pGAS[123]
S5K5CAGX_write_cmos_sensor(0x0F12, 0x00BD);            //TVAR_ash_pGAS[124]
S5K5CAGX_write_cmos_sensor(0x0F12, 0x00DA);            //TVAR_ash_pGAS[125]
S5K5CAGX_write_cmos_sensor(0x0F12, 0x0109);            //TVAR_ash_pGAS[126]
S5K5CAGX_write_cmos_sensor(0x0F12, 0x0148);            //TVAR_ash_pGAS[127]
S5K5CAGX_write_cmos_sensor(0x0F12, 0x018C);            //TVAR_ash_pGAS[128]
S5K5CAGX_write_cmos_sensor(0x0F12, 0x01BF);            //TVAR_ash_pGAS[129]
S5K5CAGX_write_cmos_sensor(0x0F12, 0x01CC);            //TVAR_ash_pGAS[130]
S5K5CAGX_write_cmos_sensor(0x0F12, 0x019F);            //TVAR_ash_pGAS[131]
S5K5CAGX_write_cmos_sensor(0x0F12, 0x016B);            //TVAR_ash_pGAS[132]
S5K5CAGX_write_cmos_sensor(0x0F12, 0x013A);            //TVAR_ash_pGAS[133]
S5K5CAGX_write_cmos_sensor(0x0F12, 0x0118);            //TVAR_ash_pGAS[134]
S5K5CAGX_write_cmos_sensor(0x0F12, 0x0108);            //TVAR_ash_pGAS[135]
S5K5CAGX_write_cmos_sensor(0x0F12, 0x0103);            //TVAR_ash_pGAS[136]
S5K5CAGX_write_cmos_sensor(0x0F12, 0x010F);            //TVAR_ash_pGAS[137]
S5K5CAGX_write_cmos_sensor(0x0F12, 0x0127);            //TVAR_ash_pGAS[138]
S5K5CAGX_write_cmos_sensor(0x0F12, 0x0159);            //TVAR_ash_pGAS[139]
S5K5CAGX_write_cmos_sensor(0x0F12, 0x018C);            //TVAR_ash_pGAS[140]
S5K5CAGX_write_cmos_sensor(0x0F12, 0x01C3);            //TVAR_ash_pGAS[141]
S5K5CAGX_write_cmos_sensor(0x0F12, 0x020F);            //TVAR_ash_pGAS[142]
S5K5CAGX_write_cmos_sensor(0x0F12, 0x015B);            //TVAR_ash_pGAS[143]
S5K5CAGX_write_cmos_sensor(0x0F12, 0x0124);            //TVAR_ash_pGAS[144]
S5K5CAGX_write_cmos_sensor(0x0F12, 0x00F0);            //TVAR_ash_pGAS[145]
S5K5CAGX_write_cmos_sensor(0x0F12, 0x00C8);            //TVAR_ash_pGAS[146]
S5K5CAGX_write_cmos_sensor(0x0F12, 0x00A9);            //TVAR_ash_pGAS[147]
S5K5CAGX_write_cmos_sensor(0x0F12, 0x0097);            //TVAR_ash_pGAS[148]
S5K5CAGX_write_cmos_sensor(0x0F12, 0x008E);            //TVAR_ash_pGAS[149]
S5K5CAGX_write_cmos_sensor(0x0F12, 0x0091);            //TVAR_ash_pGAS[150]
S5K5CAGX_write_cmos_sensor(0x0F12, 0x00A2);            //TVAR_ash_pGAS[151]
S5K5CAGX_write_cmos_sensor(0x0F12, 0x00C0);            //TVAR_ash_pGAS[152]
S5K5CAGX_write_cmos_sensor(0x0F12, 0x00E8);            //TVAR_ash_pGAS[153]
S5K5CAGX_write_cmos_sensor(0x0F12, 0x011B);            //TVAR_ash_pGAS[154]
S5K5CAGX_write_cmos_sensor(0x0F12, 0x0153);            //TVAR_ash_pGAS[155]
S5K5CAGX_write_cmos_sensor(0x0F12, 0x0139);            //TVAR_ash_pGAS[156]
S5K5CAGX_write_cmos_sensor(0x0F12, 0x00FE);            //TVAR_ash_pGAS[157]
S5K5CAGX_write_cmos_sensor(0x0F12, 0x00C3);            //TVAR_ash_pGAS[158]
S5K5CAGX_write_cmos_sensor(0x0F12, 0x009B);            //TVAR_ash_pGAS[159]
S5K5CAGX_write_cmos_sensor(0x0F12, 0x007A);            //TVAR_ash_pGAS[160]
S5K5CAGX_write_cmos_sensor(0x0F12, 0x0066);            //TVAR_ash_pGAS[161]
S5K5CAGX_write_cmos_sensor(0x0F12, 0x005F);            //TVAR_ash_pGAS[162]
S5K5CAGX_write_cmos_sensor(0x0F12, 0x0063);            //TVAR_ash_pGAS[163]
S5K5CAGX_write_cmos_sensor(0x0F12, 0x0076);            //TVAR_ash_pGAS[164]
S5K5CAGX_write_cmos_sensor(0x0F12, 0x0094);            //TVAR_ash_pGAS[165]
S5K5CAGX_write_cmos_sensor(0x0F12, 0x00BF);            //TVAR_ash_pGAS[166]
S5K5CAGX_write_cmos_sensor(0x0F12, 0x00F8);            //TVAR_ash_pGAS[167]
S5K5CAGX_write_cmos_sensor(0x0F12, 0x012F);            //TVAR_ash_pGAS[168]
S5K5CAGX_write_cmos_sensor(0x0F12, 0x0117);            //TVAR_ash_pGAS[169]
S5K5CAGX_write_cmos_sensor(0x0F12, 0x00DA);            //TVAR_ash_pGAS[170]
S5K5CAGX_write_cmos_sensor(0x0F12, 0x009D);            //TVAR_ash_pGAS[171]
S5K5CAGX_write_cmos_sensor(0x0F12, 0x0071);            //TVAR_ash_pGAS[172]
S5K5CAGX_write_cmos_sensor(0x0F12, 0x004F);            //TVAR_ash_pGAS[173]
S5K5CAGX_write_cmos_sensor(0x0F12, 0x003A);            //TVAR_ash_pGAS[174]
S5K5CAGX_write_cmos_sensor(0x0F12, 0x0033);            //TVAR_ash_pGAS[175]
S5K5CAGX_write_cmos_sensor(0x0F12, 0x0039);            //TVAR_ash_pGAS[176]
S5K5CAGX_write_cmos_sensor(0x0F12, 0x004E);            //TVAR_ash_pGAS[177]
S5K5CAGX_write_cmos_sensor(0x0F12, 0x0071);            //TVAR_ash_pGAS[178]
S5K5CAGX_write_cmos_sensor(0x0F12, 0x009E);            //TVAR_ash_pGAS[179]
S5K5CAGX_write_cmos_sensor(0x0F12, 0x00DA);            //TVAR_ash_pGAS[180]
S5K5CAGX_write_cmos_sensor(0x0F12, 0x0116);            //TVAR_ash_pGAS[181]
S5K5CAGX_write_cmos_sensor(0x0F12, 0x00FC);            //TVAR_ash_pGAS[182]
S5K5CAGX_write_cmos_sensor(0x0F12, 0x00BB);            //TVAR_ash_pGAS[183]
S5K5CAGX_write_cmos_sensor(0x0F12, 0x0082);            //TVAR_ash_pGAS[184]
S5K5CAGX_write_cmos_sensor(0x0F12, 0x0053);            //TVAR_ash_pGAS[185]
S5K5CAGX_write_cmos_sensor(0x0F12, 0x002F);            //TVAR_ash_pGAS[186]
S5K5CAGX_write_cmos_sensor(0x0F12, 0x001A);            //TVAR_ash_pGAS[187]
S5K5CAGX_write_cmos_sensor(0x0F12, 0x0013);            //TVAR_ash_pGAS[188]
S5K5CAGX_write_cmos_sensor(0x0F12, 0x001B);            //TVAR_ash_pGAS[189]
S5K5CAGX_write_cmos_sensor(0x0F12, 0x0034);            //TVAR_ash_pGAS[190]
S5K5CAGX_write_cmos_sensor(0x0F12, 0x0057);            //TVAR_ash_pGAS[191]
S5K5CAGX_write_cmos_sensor(0x0F12, 0x0088);            //TVAR_ash_pGAS[192]
S5K5CAGX_write_cmos_sensor(0x0F12, 0x00C5);            //TVAR_ash_pGAS[193]
S5K5CAGX_write_cmos_sensor(0x0F12, 0x0104);            //TVAR_ash_pGAS[194]
S5K5CAGX_write_cmos_sensor(0x0F12, 0x00ED);            //TVAR_ash_pGAS[195]
S5K5CAGX_write_cmos_sensor(0x0F12, 0x00AE);            //TVAR_ash_pGAS[196]
S5K5CAGX_write_cmos_sensor(0x0F12, 0x0074);            //TVAR_ash_pGAS[197]
S5K5CAGX_write_cmos_sensor(0x0F12, 0x0043);            //TVAR_ash_pGAS[198]
S5K5CAGX_write_cmos_sensor(0x0F12, 0x001E);            //TVAR_ash_pGAS[199]
S5K5CAGX_write_cmos_sensor(0x0F12, 0x0009);            //TVAR_ash_pGAS[200]
S5K5CAGX_write_cmos_sensor(0x0F12, 0x0002);            //TVAR_ash_pGAS[201]
S5K5CAGX_write_cmos_sensor(0x0F12, 0x000C);            //TVAR_ash_pGAS[202]
S5K5CAGX_write_cmos_sensor(0x0F12, 0x0025);            //TVAR_ash_pGAS[203]
S5K5CAGX_write_cmos_sensor(0x0F12, 0x004B);            //TVAR_ash_pGAS[204]
S5K5CAGX_write_cmos_sensor(0x0F12, 0x007A);            //TVAR_ash_pGAS[205]
S5K5CAGX_write_cmos_sensor(0x0F12, 0x00BB);            //TVAR_ash_pGAS[206]
S5K5CAGX_write_cmos_sensor(0x0F12, 0x00FC);            //TVAR_ash_pGAS[207]
S5K5CAGX_write_cmos_sensor(0x0F12, 0x00ED);            //TVAR_ash_pGAS[208]
S5K5CAGX_write_cmos_sensor(0x0F12, 0x00AB);            //TVAR_ash_pGAS[209]
S5K5CAGX_write_cmos_sensor(0x0F12, 0x0070);            //TVAR_ash_pGAS[210]
S5K5CAGX_write_cmos_sensor(0x0F12, 0x003F);            //TVAR_ash_pGAS[211]
S5K5CAGX_write_cmos_sensor(0x0F12, 0x001C);            //TVAR_ash_pGAS[212]
S5K5CAGX_write_cmos_sensor(0x0F12, 0x0006);            //TVAR_ash_pGAS[213]
S5K5CAGX_write_cmos_sensor(0x0F12, 0x0000);            //TVAR_ash_pGAS[214]
S5K5CAGX_write_cmos_sensor(0x0F12, 0x000B);            //TVAR_ash_pGAS[215]
S5K5CAGX_write_cmos_sensor(0x0F12, 0x0025);            //TVAR_ash_pGAS[216]
S5K5CAGX_write_cmos_sensor(0x0F12, 0x004D);            //TVAR_ash_pGAS[217]
S5K5CAGX_write_cmos_sensor(0x0F12, 0x007D);            //TVAR_ash_pGAS[218]
S5K5CAGX_write_cmos_sensor(0x0F12, 0x00BD);            //TVAR_ash_pGAS[219]
S5K5CAGX_write_cmos_sensor(0x0F12, 0x0104);            //TVAR_ash_pGAS[220]
S5K5CAGX_write_cmos_sensor(0x0F12, 0x00F8);            //TVAR_ash_pGAS[221]
S5K5CAGX_write_cmos_sensor(0x0F12, 0x00B8);            //TVAR_ash_pGAS[222]
S5K5CAGX_write_cmos_sensor(0x0F12, 0x007D);            //TVAR_ash_pGAS[223]
S5K5CAGX_write_cmos_sensor(0x0F12, 0x004D);            //TVAR_ash_pGAS[224]
S5K5CAGX_write_cmos_sensor(0x0F12, 0x0029);            //TVAR_ash_pGAS[225]
S5K5CAGX_write_cmos_sensor(0x0F12, 0x0013);            //TVAR_ash_pGAS[226]
S5K5CAGX_write_cmos_sensor(0x0F12, 0x000F);            //TVAR_ash_pGAS[227]
S5K5CAGX_write_cmos_sensor(0x0F12, 0x001A);            //TVAR_ash_pGAS[228]
S5K5CAGX_write_cmos_sensor(0x0F12, 0x0035);            //TVAR_ash_pGAS[229]
S5K5CAGX_write_cmos_sensor(0x0F12, 0x005C);            //TVAR_ash_pGAS[230]
S5K5CAGX_write_cmos_sensor(0x0F12, 0x008C);            //TVAR_ash_pGAS[231]
S5K5CAGX_write_cmos_sensor(0x0F12, 0x00CC);            //TVAR_ash_pGAS[232]
S5K5CAGX_write_cmos_sensor(0x0F12, 0x0114);            //TVAR_ash_pGAS[233]
S5K5CAGX_write_cmos_sensor(0x0F12, 0x0110);            //TVAR_ash_pGAS[234]
S5K5CAGX_write_cmos_sensor(0x0F12, 0x00D1);            //TVAR_ash_pGAS[235]
S5K5CAGX_write_cmos_sensor(0x0F12, 0x0097);            //TVAR_ash_pGAS[236]
S5K5CAGX_write_cmos_sensor(0x0F12, 0x0067);            //TVAR_ash_pGAS[237]
S5K5CAGX_write_cmos_sensor(0x0F12, 0x0044);            //TVAR_ash_pGAS[238]
S5K5CAGX_write_cmos_sensor(0x0F12, 0x0030);            //TVAR_ash_pGAS[239]
S5K5CAGX_write_cmos_sensor(0x0F12, 0x002C);            //TVAR_ash_pGAS[240]
S5K5CAGX_write_cmos_sensor(0x0F12, 0x0038);            //TVAR_ash_pGAS[241]
S5K5CAGX_write_cmos_sensor(0x0F12, 0x0052);            //TVAR_ash_pGAS[242]
S5K5CAGX_write_cmos_sensor(0x0F12, 0x007B);            //TVAR_ash_pGAS[243]
S5K5CAGX_write_cmos_sensor(0x0F12, 0x00AB);            //TVAR_ash_pGAS[244]
S5K5CAGX_write_cmos_sensor(0x0F12, 0x00E7);            //TVAR_ash_pGAS[245]
S5K5CAGX_write_cmos_sensor(0x0F12, 0x012C);            //TVAR_ash_pGAS[246]
S5K5CAGX_write_cmos_sensor(0x0F12, 0x0132);            //TVAR_ash_pGAS[247]
S5K5CAGX_write_cmos_sensor(0x0F12, 0x00F6);            //TVAR_ash_pGAS[248]
S5K5CAGX_write_cmos_sensor(0x0F12, 0x00BB);            //TVAR_ash_pGAS[249]
S5K5CAGX_write_cmos_sensor(0x0F12, 0x008F);            //TVAR_ash_pGAS[250]
S5K5CAGX_write_cmos_sensor(0x0F12, 0x006D);            //TVAR_ash_pGAS[251]
S5K5CAGX_write_cmos_sensor(0x0F12, 0x005B);            //TVAR_ash_pGAS[252]
S5K5CAGX_write_cmos_sensor(0x0F12, 0x0057);            //TVAR_ash_pGAS[253]
S5K5CAGX_write_cmos_sensor(0x0F12, 0x0062);            //TVAR_ash_pGAS[254]
S5K5CAGX_write_cmos_sensor(0x0F12, 0x007E);            //TVAR_ash_pGAS[255]
S5K5CAGX_write_cmos_sensor(0x0F12, 0x00A5);            //TVAR_ash_pGAS[256]
S5K5CAGX_write_cmos_sensor(0x0F12, 0x00D4);            //TVAR_ash_pGAS[257]
S5K5CAGX_write_cmos_sensor(0x0F12, 0x0110);            //TVAR_ash_pGAS[258]
S5K5CAGX_write_cmos_sensor(0x0F12, 0x014D);            //TVAR_ash_pGAS[259]
S5K5CAGX_write_cmos_sensor(0x0F12, 0x0159);            //TVAR_ash_pGAS[260]
S5K5CAGX_write_cmos_sensor(0x0F12, 0x0128);            //TVAR_ash_pGAS[261]
S5K5CAGX_write_cmos_sensor(0x0F12, 0x00F0);            //TVAR_ash_pGAS[262]
S5K5CAGX_write_cmos_sensor(0x0F12, 0x00C3);            //TVAR_ash_pGAS[263]
S5K5CAGX_write_cmos_sensor(0x0F12, 0x00A6);            //TVAR_ash_pGAS[264]
S5K5CAGX_write_cmos_sensor(0x0F12, 0x0097);            //TVAR_ash_pGAS[265]
S5K5CAGX_write_cmos_sensor(0x0F12, 0x0095);            //TVAR_ash_pGAS[266]
S5K5CAGX_write_cmos_sensor(0x0F12, 0x009F);            //TVAR_ash_pGAS[267]
S5K5CAGX_write_cmos_sensor(0x0F12, 0x00B8);            //TVAR_ash_pGAS[268]
S5K5CAGX_write_cmos_sensor(0x0F12, 0x00DE);            //TVAR_ash_pGAS[269]
S5K5CAGX_write_cmos_sensor(0x0F12, 0x010E);            //TVAR_ash_pGAS[270]
S5K5CAGX_write_cmos_sensor(0x0F12, 0x0145);            //TVAR_ash_pGAS[271]
S5K5CAGX_write_cmos_sensor(0x0F12, 0x0170);            //TVAR_ash_pGAS[272]
S5K5CAGX_write_cmos_sensor(0x0F12, 0x0183);            //TVAR_ash_pGAS[273]
S5K5CAGX_write_cmos_sensor(0x0F12, 0x0155);            //TVAR_ash_pGAS[274]
S5K5CAGX_write_cmos_sensor(0x0F12, 0x0128);            //TVAR_ash_pGAS[275]
S5K5CAGX_write_cmos_sensor(0x0F12, 0x00FE);            //TVAR_ash_pGAS[276]
S5K5CAGX_write_cmos_sensor(0x0F12, 0x00E3);            //TVAR_ash_pGAS[277]
S5K5CAGX_write_cmos_sensor(0x0F12, 0x00D4);            //TVAR_ash_pGAS[278]
S5K5CAGX_write_cmos_sensor(0x0F12, 0x00D2);            //TVAR_ash_pGAS[279]
S5K5CAGX_write_cmos_sensor(0x0F12, 0x00DE);            //TVAR_ash_pGAS[280]
S5K5CAGX_write_cmos_sensor(0x0F12, 0x00F6);            //TVAR_ash_pGAS[281]
S5K5CAGX_write_cmos_sensor(0x0F12, 0x011F);            //TVAR_ash_pGAS[282]
S5K5CAGX_write_cmos_sensor(0x0F12, 0x014C);            //TVAR_ash_pGAS[283]
S5K5CAGX_write_cmos_sensor(0x0F12, 0x0177);            //TVAR_ash_pGAS[284]
S5K5CAGX_write_cmos_sensor(0x0F12, 0x01B6);            //TVAR_ash_pGAS[285]
S5K5CAGX_write_cmos_sensor(0x0F12, 0x0147);            //TVAR_ash_pGAS[286]
S5K5CAGX_write_cmos_sensor(0x0F12, 0x0114);            //TVAR_ash_pGAS[287]
S5K5CAGX_write_cmos_sensor(0x0F12, 0x00E2);            //TVAR_ash_pGAS[288]
S5K5CAGX_write_cmos_sensor(0x0F12, 0x00B9);            //TVAR_ash_pGAS[289]
S5K5CAGX_write_cmos_sensor(0x0F12, 0x009E);            //TVAR_ash_pGAS[290]
S5K5CAGX_write_cmos_sensor(0x0F12, 0x0091);            //TVAR_ash_pGAS[291]
S5K5CAGX_write_cmos_sensor(0x0F12, 0x008E);            //TVAR_ash_pGAS[292]
S5K5CAGX_write_cmos_sensor(0x0F12, 0x0097);            //TVAR_ash_pGAS[293]
S5K5CAGX_write_cmos_sensor(0x0F12, 0x00AC);            //TVAR_ash_pGAS[294]
S5K5CAGX_write_cmos_sensor(0x0F12, 0x00D0);            //TVAR_ash_pGAS[295]
S5K5CAGX_write_cmos_sensor(0x0F12, 0x00FB);            //TVAR_ash_pGAS[296]
S5K5CAGX_write_cmos_sensor(0x0F12, 0x012E);            //TVAR_ash_pGAS[297]
S5K5CAGX_write_cmos_sensor(0x0F12, 0x0161);            //TVAR_ash_pGAS[298]
S5K5CAGX_write_cmos_sensor(0x0F12, 0x012C);            //TVAR_ash_pGAS[299]
S5K5CAGX_write_cmos_sensor(0x0F12, 0x00F1);            //TVAR_ash_pGAS[300]
S5K5CAGX_write_cmos_sensor(0x0F12, 0x00B8);            //TVAR_ash_pGAS[301]
S5K5CAGX_write_cmos_sensor(0x0F12, 0x0090);            //TVAR_ash_pGAS[302]
S5K5CAGX_write_cmos_sensor(0x0F12, 0x0072);            //TVAR_ash_pGAS[303]
S5K5CAGX_write_cmos_sensor(0x0F12, 0x0063);            //TVAR_ash_pGAS[304]
S5K5CAGX_write_cmos_sensor(0x0F12, 0x0060);            //TVAR_ash_pGAS[305]
S5K5CAGX_write_cmos_sensor(0x0F12, 0x0068);            //TVAR_ash_pGAS[306]
S5K5CAGX_write_cmos_sensor(0x0F12, 0x007F);            //TVAR_ash_pGAS[307]
S5K5CAGX_write_cmos_sensor(0x0F12, 0x00A1);            //TVAR_ash_pGAS[308]
S5K5CAGX_write_cmos_sensor(0x0F12, 0x00D0);            //TVAR_ash_pGAS[309]
S5K5CAGX_write_cmos_sensor(0x0F12, 0x010B);            //TVAR_ash_pGAS[310]
S5K5CAGX_write_cmos_sensor(0x0F12, 0x0140);            //TVAR_ash_pGAS[311]
S5K5CAGX_write_cmos_sensor(0x0F12, 0x010F);            //TVAR_ash_pGAS[312]
S5K5CAGX_write_cmos_sensor(0x0F12, 0x00D1);            //TVAR_ash_pGAS[313]
S5K5CAGX_write_cmos_sensor(0x0F12, 0x0096);            //TVAR_ash_pGAS[314]
S5K5CAGX_write_cmos_sensor(0x0F12, 0x006A);            //TVAR_ash_pGAS[315]
S5K5CAGX_write_cmos_sensor(0x0F12, 0x004A);            //TVAR_ash_pGAS[316]
S5K5CAGX_write_cmos_sensor(0x0F12, 0x0038);            //TVAR_ash_pGAS[317]
S5K5CAGX_write_cmos_sensor(0x0F12, 0x0033);            //TVAR_ash_pGAS[318]
S5K5CAGX_write_cmos_sensor(0x0F12, 0x003D);            //TVAR_ash_pGAS[319]
S5K5CAGX_write_cmos_sensor(0x0F12, 0x0055);            //TVAR_ash_pGAS[320]
S5K5CAGX_write_cmos_sensor(0x0F12, 0x007B);            //TVAR_ash_pGAS[321]
S5K5CAGX_write_cmos_sensor(0x0F12, 0x00AB);            //TVAR_ash_pGAS[322]
S5K5CAGX_write_cmos_sensor(0x0F12, 0x00E8);            //TVAR_ash_pGAS[323]
S5K5CAGX_write_cmos_sensor(0x0F12, 0x0127);            //TVAR_ash_pGAS[324]
S5K5CAGX_write_cmos_sensor(0x0F12, 0x00F8);            //TVAR_ash_pGAS[325]
S5K5CAGX_write_cmos_sensor(0x0F12, 0x00B8);            //TVAR_ash_pGAS[326]
S5K5CAGX_write_cmos_sensor(0x0F12, 0x007E);            //TVAR_ash_pGAS[327]
S5K5CAGX_write_cmos_sensor(0x0F12, 0x0050);            //TVAR_ash_pGAS[328]
S5K5CAGX_write_cmos_sensor(0x0F12, 0x002D);            //TVAR_ash_pGAS[329]
S5K5CAGX_write_cmos_sensor(0x0F12, 0x0019);            //TVAR_ash_pGAS[330]
S5K5CAGX_write_cmos_sensor(0x0F12, 0x0014);            //TVAR_ash_pGAS[331]
S5K5CAGX_write_cmos_sensor(0x0F12, 0x001E);            //TVAR_ash_pGAS[332]
S5K5CAGX_write_cmos_sensor(0x0F12, 0x0039);            //TVAR_ash_pGAS[333]
S5K5CAGX_write_cmos_sensor(0x0F12, 0x005F);            //TVAR_ash_pGAS[334]
S5K5CAGX_write_cmos_sensor(0x0F12, 0x0091);            //TVAR_ash_pGAS[335]
S5K5CAGX_write_cmos_sensor(0x0F12, 0x00CD);            //TVAR_ash_pGAS[336]
S5K5CAGX_write_cmos_sensor(0x0F12, 0x0110);            //TVAR_ash_pGAS[337]
S5K5CAGX_write_cmos_sensor(0x0F12, 0x00F2);            //TVAR_ash_pGAS[338]
S5K5CAGX_write_cmos_sensor(0x0F12, 0x00AE);            //TVAR_ash_pGAS[339]
S5K5CAGX_write_cmos_sensor(0x0F12, 0x0074);            //TVAR_ash_pGAS[340]
S5K5CAGX_write_cmos_sensor(0x0F12, 0x0042);            //TVAR_ash_pGAS[341]
S5K5CAGX_write_cmos_sensor(0x0F12, 0x001F);            //TVAR_ash_pGAS[342]
S5K5CAGX_write_cmos_sensor(0x0F12, 0x0008);            //TVAR_ash_pGAS[343]
S5K5CAGX_write_cmos_sensor(0x0F12, 0x0002);            //TVAR_ash_pGAS[344]
S5K5CAGX_write_cmos_sensor(0x0F12, 0x000D);            //TVAR_ash_pGAS[345]
S5K5CAGX_write_cmos_sensor(0x0F12, 0x0028);            //TVAR_ash_pGAS[346]
S5K5CAGX_write_cmos_sensor(0x0F12, 0x004F);            //TVAR_ash_pGAS[347]
S5K5CAGX_write_cmos_sensor(0x0F12, 0x007F);            //TVAR_ash_pGAS[348]
S5K5CAGX_write_cmos_sensor(0x0F12, 0x00BF);            //TVAR_ash_pGAS[349]
S5K5CAGX_write_cmos_sensor(0x0F12, 0x0101);            //TVAR_ash_pGAS[350]
S5K5CAGX_write_cmos_sensor(0x0F12, 0x00F7);            //TVAR_ash_pGAS[351]
S5K5CAGX_write_cmos_sensor(0x0F12, 0x00B1);            //TVAR_ash_pGAS[352]
S5K5CAGX_write_cmos_sensor(0x0F12, 0x0076);            //TVAR_ash_pGAS[353]
S5K5CAGX_write_cmos_sensor(0x0F12, 0x0043);            //TVAR_ash_pGAS[354]
S5K5CAGX_write_cmos_sensor(0x0F12, 0x001E);            //TVAR_ash_pGAS[355]
S5K5CAGX_write_cmos_sensor(0x0F12, 0x0007);            //TVAR_ash_pGAS[356]
S5K5CAGX_write_cmos_sensor(0x0F12, 0x0000);            //TVAR_ash_pGAS[357]
S5K5CAGX_write_cmos_sensor(0x0F12, 0x000A);            //TVAR_ash_pGAS[358]
S5K5CAGX_write_cmos_sensor(0x0F12, 0x0025);            //TVAR_ash_pGAS[359]
S5K5CAGX_write_cmos_sensor(0x0F12, 0x004B);            //TVAR_ash_pGAS[360]
S5K5CAGX_write_cmos_sensor(0x0F12, 0x007C);            //TVAR_ash_pGAS[361]
S5K5CAGX_write_cmos_sensor(0x0F12, 0x00BB);            //TVAR_ash_pGAS[362]
S5K5CAGX_write_cmos_sensor(0x0F12, 0x0103);            //TVAR_ash_pGAS[363]
S5K5CAGX_write_cmos_sensor(0x0F12, 0x0107);            //TVAR_ash_pGAS[364]
S5K5CAGX_write_cmos_sensor(0x0F12, 0x00C3);            //TVAR_ash_pGAS[365]
S5K5CAGX_write_cmos_sensor(0x0F12, 0x0087);            //TVAR_ash_pGAS[366]
S5K5CAGX_write_cmos_sensor(0x0F12, 0x0054);            //TVAR_ash_pGAS[367]
S5K5CAGX_write_cmos_sensor(0x0F12, 0x002D);            //TVAR_ash_pGAS[368]
S5K5CAGX_write_cmos_sensor(0x0F12, 0x0015);            //TVAR_ash_pGAS[369]
S5K5CAGX_write_cmos_sensor(0x0F12, 0x000F);            //TVAR_ash_pGAS[370]
S5K5CAGX_write_cmos_sensor(0x0F12, 0x0016);            //TVAR_ash_pGAS[371]
S5K5CAGX_write_cmos_sensor(0x0F12, 0x0030);            //TVAR_ash_pGAS[372]
S5K5CAGX_write_cmos_sensor(0x0F12, 0x0056);            //TVAR_ash_pGAS[373]
S5K5CAGX_write_cmos_sensor(0x0F12, 0x0086);            //TVAR_ash_pGAS[374]
S5K5CAGX_write_cmos_sensor(0x0F12, 0x00C3);            //TVAR_ash_pGAS[375]
S5K5CAGX_write_cmos_sensor(0x0F12, 0x010D);            //TVAR_ash_pGAS[376]
S5K5CAGX_write_cmos_sensor(0x0F12, 0x0127);            //TVAR_ash_pGAS[377]
S5K5CAGX_write_cmos_sensor(0x0F12, 0x00E3);            //TVAR_ash_pGAS[378]
S5K5CAGX_write_cmos_sensor(0x0F12, 0x00A6);            //TVAR_ash_pGAS[379]
S5K5CAGX_write_cmos_sensor(0x0F12, 0x0073);            //TVAR_ash_pGAS[380]
S5K5CAGX_write_cmos_sensor(0x0F12, 0x004C);            //TVAR_ash_pGAS[381]
S5K5CAGX_write_cmos_sensor(0x0F12, 0x0033);            //TVAR_ash_pGAS[382]
S5K5CAGX_write_cmos_sensor(0x0F12, 0x002B);            //TVAR_ash_pGAS[383]
S5K5CAGX_write_cmos_sensor(0x0F12, 0x0033);            //TVAR_ash_pGAS[384]
S5K5CAGX_write_cmos_sensor(0x0F12, 0x004B);            //TVAR_ash_pGAS[385]
S5K5CAGX_write_cmos_sensor(0x0F12, 0x0071);            //TVAR_ash_pGAS[386]
S5K5CAGX_write_cmos_sensor(0x0F12, 0x009E);            //TVAR_ash_pGAS[387]
S5K5CAGX_write_cmos_sensor(0x0F12, 0x00DB);            //TVAR_ash_pGAS[388]
S5K5CAGX_write_cmos_sensor(0x0F12, 0x011F);            //TVAR_ash_pGAS[389]
S5K5CAGX_write_cmos_sensor(0x0F12, 0x014D);            //TVAR_ash_pGAS[390]
S5K5CAGX_write_cmos_sensor(0x0F12, 0x010C);            //TVAR_ash_pGAS[391]
S5K5CAGX_write_cmos_sensor(0x0F12, 0x00CF);            //TVAR_ash_pGAS[392]
S5K5CAGX_write_cmos_sensor(0x0F12, 0x009E);            //TVAR_ash_pGAS[393]
S5K5CAGX_write_cmos_sensor(0x0F12, 0x0079);            //TVAR_ash_pGAS[394]
S5K5CAGX_write_cmos_sensor(0x0F12, 0x0061);            //TVAR_ash_pGAS[395]
S5K5CAGX_write_cmos_sensor(0x0F12, 0x0056);            //TVAR_ash_pGAS[396]
S5K5CAGX_write_cmos_sensor(0x0F12, 0x005D);            //TVAR_ash_pGAS[397]
S5K5CAGX_write_cmos_sensor(0x0F12, 0x0073);            //TVAR_ash_pGAS[398]
S5K5CAGX_write_cmos_sensor(0x0F12, 0x0096);            //TVAR_ash_pGAS[399]
S5K5CAGX_write_cmos_sensor(0x0F12, 0x00C3);            //TVAR_ash_pGAS[400]
S5K5CAGX_write_cmos_sensor(0x0F12, 0x00FD);            //TVAR_ash_pGAS[401]
S5K5CAGX_write_cmos_sensor(0x0F12, 0x013E);            //TVAR_ash_pGAS[402]
S5K5CAGX_write_cmos_sensor(0x0F12, 0x017C);            //TVAR_ash_pGAS[403]
S5K5CAGX_write_cmos_sensor(0x0F12, 0x0143);            //TVAR_ash_pGAS[404]
S5K5CAGX_write_cmos_sensor(0x0F12, 0x0108);            //TVAR_ash_pGAS[405]
S5K5CAGX_write_cmos_sensor(0x0F12, 0x00D9);            //TVAR_ash_pGAS[406]
S5K5CAGX_write_cmos_sensor(0x0F12, 0x00B6);            //TVAR_ash_pGAS[407]
S5K5CAGX_write_cmos_sensor(0x0F12, 0x00A0);            //TVAR_ash_pGAS[408]
S5K5CAGX_write_cmos_sensor(0x0F12, 0x0096);            //TVAR_ash_pGAS[409]
S5K5CAGX_write_cmos_sensor(0x0F12, 0x0099);            //TVAR_ash_pGAS[410]
S5K5CAGX_write_cmos_sensor(0x0F12, 0x00AC);            //TVAR_ash_pGAS[411]
S5K5CAGX_write_cmos_sensor(0x0F12, 0x00CE);            //TVAR_ash_pGAS[412]
S5K5CAGX_write_cmos_sensor(0x0F12, 0x00F9);            //TVAR_ash_pGAS[413]
S5K5CAGX_write_cmos_sensor(0x0F12, 0x012F);            //TVAR_ash_pGAS[414]
S5K5CAGX_write_cmos_sensor(0x0F12, 0x0160);            //TVAR_ash_pGAS[415]
S5K5CAGX_write_cmos_sensor(0x0F12, 0x01AE);            //TVAR_ash_pGAS[416]
S5K5CAGX_write_cmos_sensor(0x0F12, 0x0177);            //TVAR_ash_pGAS[417]
S5K5CAGX_write_cmos_sensor(0x0F12, 0x0145);            //TVAR_ash_pGAS[418]
S5K5CAGX_write_cmos_sensor(0x0F12, 0x0118);            //TVAR_ash_pGAS[419]
S5K5CAGX_write_cmos_sensor(0x0F12, 0x00F8);            //TVAR_ash_pGAS[420]
S5K5CAGX_write_cmos_sensor(0x0F12, 0x00E2);            //TVAR_ash_pGAS[421]
S5K5CAGX_write_cmos_sensor(0x0F12, 0x00D7);            //TVAR_ash_pGAS[422]
S5K5CAGX_write_cmos_sensor(0x0F12, 0x00DB);            //TVAR_ash_pGAS[423]
S5K5CAGX_write_cmos_sensor(0x0F12, 0x00EB);            //TVAR_ash_pGAS[424]
S5K5CAGX_write_cmos_sensor(0x0F12, 0x010E);            //TVAR_ash_pGAS[425]
S5K5CAGX_write_cmos_sensor(0x0F12, 0x0135);            //TVAR_ash_pGAS[426]
S5K5CAGX_write_cmos_sensor(0x0F12, 0x0163);            //TVAR_ash_pGAS[427]
S5K5CAGX_write_cmos_sensor(0x0F12, 0x01AC);            //TVAR_ash_pGAS[428]
S5K5CAGX_write_cmos_sensor(0x0F12, 0x0117);            //TVAR_ash_pGAS[429]
S5K5CAGX_write_cmos_sensor(0x0F12, 0x00EA);            //TVAR_ash_pGAS[430]
S5K5CAGX_write_cmos_sensor(0x0F12, 0x00BD);            //TVAR_ash_pGAS[431]
S5K5CAGX_write_cmos_sensor(0x0F12, 0x009F);            //TVAR_ash_pGAS[432]
S5K5CAGX_write_cmos_sensor(0x0F12, 0x008B);            //TVAR_ash_pGAS[433]
S5K5CAGX_write_cmos_sensor(0x0F12, 0x0082);            //TVAR_ash_pGAS[434]
S5K5CAGX_write_cmos_sensor(0x0F12, 0x0080);            //TVAR_ash_pGAS[435]
S5K5CAGX_write_cmos_sensor(0x0F12, 0x0089);            //TVAR_ash_pGAS[436]
S5K5CAGX_write_cmos_sensor(0x0F12, 0x009A);            //TVAR_ash_pGAS[437]
S5K5CAGX_write_cmos_sensor(0x0F12, 0x00B7);            //TVAR_ash_pGAS[438]
S5K5CAGX_write_cmos_sensor(0x0F12, 0x00DF);            //TVAR_ash_pGAS[439]
S5K5CAGX_write_cmos_sensor(0x0F12, 0x0111);            //TVAR_ash_pGAS[440]
S5K5CAGX_write_cmos_sensor(0x0F12, 0x013A);            //TVAR_ash_pGAS[441]
S5K5CAGX_write_cmos_sensor(0x0F12, 0x00F7);            //TVAR_ash_pGAS[442]
S5K5CAGX_write_cmos_sensor(0x0F12, 0x00C6);            //TVAR_ash_pGAS[443]
S5K5CAGX_write_cmos_sensor(0x0F12, 0x0096);            //TVAR_ash_pGAS[444]
S5K5CAGX_write_cmos_sensor(0x0F12, 0x0079);            //TVAR_ash_pGAS[445]
S5K5CAGX_write_cmos_sensor(0x0F12, 0x0065);            //TVAR_ash_pGAS[446]
S5K5CAGX_write_cmos_sensor(0x0F12, 0x0059);            //TVAR_ash_pGAS[447]
S5K5CAGX_write_cmos_sensor(0x0F12, 0x005A);            //TVAR_ash_pGAS[448]
S5K5CAGX_write_cmos_sensor(0x0F12, 0x0061);            //TVAR_ash_pGAS[449]
S5K5CAGX_write_cmos_sensor(0x0F12, 0x0073);            //TVAR_ash_pGAS[450]
S5K5CAGX_write_cmos_sensor(0x0F12, 0x0090);            //TVAR_ash_pGAS[451]
S5K5CAGX_write_cmos_sensor(0x0F12, 0x00B7);            //TVAR_ash_pGAS[452]
S5K5CAGX_write_cmos_sensor(0x0F12, 0x00EE);            //TVAR_ash_pGAS[453]
S5K5CAGX_write_cmos_sensor(0x0F12, 0x0119);            //TVAR_ash_pGAS[454]
S5K5CAGX_write_cmos_sensor(0x0F12, 0x00CF);            //TVAR_ash_pGAS[455]
S5K5CAGX_write_cmos_sensor(0x0F12, 0x00A2);            //TVAR_ash_pGAS[456]
S5K5CAGX_write_cmos_sensor(0x0F12, 0x0073);            //TVAR_ash_pGAS[457]
S5K5CAGX_write_cmos_sensor(0x0F12, 0x0054);            //TVAR_ash_pGAS[458]
S5K5CAGX_write_cmos_sensor(0x0F12, 0x0040);            //TVAR_ash_pGAS[459]
S5K5CAGX_write_cmos_sensor(0x0F12, 0x0035);            //TVAR_ash_pGAS[460]
S5K5CAGX_write_cmos_sensor(0x0F12, 0x0032);            //TVAR_ash_pGAS[461]
S5K5CAGX_write_cmos_sensor(0x0F12, 0x003A);            //TVAR_ash_pGAS[462]
S5K5CAGX_write_cmos_sensor(0x0F12, 0x004D);            //TVAR_ash_pGAS[463]
S5K5CAGX_write_cmos_sensor(0x0F12, 0x006B);            //TVAR_ash_pGAS[464]
S5K5CAGX_write_cmos_sensor(0x0F12, 0x0092);            //TVAR_ash_pGAS[465]
S5K5CAGX_write_cmos_sensor(0x0F12, 0x00CA);            //TVAR_ash_pGAS[466]
S5K5CAGX_write_cmos_sensor(0x0F12, 0x00FD);            //TVAR_ash_pGAS[467]
S5K5CAGX_write_cmos_sensor(0x0F12, 0x00B7);            //TVAR_ash_pGAS[468]
S5K5CAGX_write_cmos_sensor(0x0F12, 0x0088);            //TVAR_ash_pGAS[469]
S5K5CAGX_write_cmos_sensor(0x0F12, 0x005B);            //TVAR_ash_pGAS[470]
S5K5CAGX_write_cmos_sensor(0x0F12, 0x003B);            //TVAR_ash_pGAS[471]
S5K5CAGX_write_cmos_sensor(0x0F12, 0x0024);            //TVAR_ash_pGAS[472]
S5K5CAGX_write_cmos_sensor(0x0F12, 0x0018);            //TVAR_ash_pGAS[473]
S5K5CAGX_write_cmos_sensor(0x0F12, 0x0014);            //TVAR_ash_pGAS[474]
S5K5CAGX_write_cmos_sensor(0x0F12, 0x001D);            //TVAR_ash_pGAS[475]
S5K5CAGX_write_cmos_sensor(0x0F12, 0x0032);            //TVAR_ash_pGAS[476]
S5K5CAGX_write_cmos_sensor(0x0F12, 0x004F);            //TVAR_ash_pGAS[477]
S5K5CAGX_write_cmos_sensor(0x0F12, 0x0077);            //TVAR_ash_pGAS[478]
S5K5CAGX_write_cmos_sensor(0x0F12, 0x00AD);            //TVAR_ash_pGAS[479]
S5K5CAGX_write_cmos_sensor(0x0F12, 0x00E4);            //TVAR_ash_pGAS[480]
S5K5CAGX_write_cmos_sensor(0x0F12, 0x00AA);            //TVAR_ash_pGAS[481]
S5K5CAGX_write_cmos_sensor(0x0F12, 0x007C);            //TVAR_ash_pGAS[482]
S5K5CAGX_write_cmos_sensor(0x0F12, 0x004E);            //TVAR_ash_pGAS[483]
S5K5CAGX_write_cmos_sensor(0x0F12, 0x002C);            //TVAR_ash_pGAS[484]
S5K5CAGX_write_cmos_sensor(0x0F12, 0x0015);            //TVAR_ash_pGAS[485]
S5K5CAGX_write_cmos_sensor(0x0F12, 0x0007);            //TVAR_ash_pGAS[486]
S5K5CAGX_write_cmos_sensor(0x0F12, 0x0003);            //TVAR_ash_pGAS[487]
S5K5CAGX_write_cmos_sensor(0x0F12, 0x000C);            //TVAR_ash_pGAS[488]
S5K5CAGX_write_cmos_sensor(0x0F12, 0x001F);            //TVAR_ash_pGAS[489]
S5K5CAGX_write_cmos_sensor(0x0F12, 0x003F);            //TVAR_ash_pGAS[490]
S5K5CAGX_write_cmos_sensor(0x0F12, 0x0064);            //TVAR_ash_pGAS[491]
S5K5CAGX_write_cmos_sensor(0x0F12, 0x009D);            //TVAR_ash_pGAS[492]
S5K5CAGX_write_cmos_sensor(0x0F12, 0x00D4);            //TVAR_ash_pGAS[493]
S5K5CAGX_write_cmos_sensor(0x0F12, 0x00AC);            //TVAR_ash_pGAS[494]
S5K5CAGX_write_cmos_sensor(0x0F12, 0x007C);            //TVAR_ash_pGAS[495]
S5K5CAGX_write_cmos_sensor(0x0F12, 0x004F);            //TVAR_ash_pGAS[496]
S5K5CAGX_write_cmos_sensor(0x0F12, 0x002B);            //TVAR_ash_pGAS[497]
S5K5CAGX_write_cmos_sensor(0x0F12, 0x0013);            //TVAR_ash_pGAS[498]
S5K5CAGX_write_cmos_sensor(0x0F12, 0x0004);            //TVAR_ash_pGAS[499]
S5K5CAGX_write_cmos_sensor(0x0F12, 0x0000);            //TVAR_ash_pGAS[500]
S5K5CAGX_write_cmos_sensor(0x0F12, 0x0008);            //TVAR_ash_pGAS[501]
S5K5CAGX_write_cmos_sensor(0x0F12, 0x001C);            //TVAR_ash_pGAS[502]
S5K5CAGX_write_cmos_sensor(0x0F12, 0x0039);            //TVAR_ash_pGAS[503]
S5K5CAGX_write_cmos_sensor(0x0F12, 0x005F);            //TVAR_ash_pGAS[504]
S5K5CAGX_write_cmos_sensor(0x0F12, 0x0095);            //TVAR_ash_pGAS[505]
S5K5CAGX_write_cmos_sensor(0x0F12, 0x00D2);            //TVAR_ash_pGAS[506]
S5K5CAGX_write_cmos_sensor(0x0F12, 0x00B9);            //TVAR_ash_pGAS[507]
S5K5CAGX_write_cmos_sensor(0x0F12, 0x0088);            //TVAR_ash_pGAS[508]
S5K5CAGX_write_cmos_sensor(0x0F12, 0x005C);            //TVAR_ash_pGAS[509]
S5K5CAGX_write_cmos_sensor(0x0F12, 0x0039);            //TVAR_ash_pGAS[510]
S5K5CAGX_write_cmos_sensor(0x0F12, 0x001F);            //TVAR_ash_pGAS[511]
S5K5CAGX_write_cmos_sensor(0x0F12, 0x0010);            //TVAR_ash_pGAS[512]
S5K5CAGX_write_cmos_sensor(0x0F12, 0x000C);            //TVAR_ash_pGAS[513]
S5K5CAGX_write_cmos_sensor(0x0F12, 0x0012);            //TVAR_ash_pGAS[514]
S5K5CAGX_write_cmos_sensor(0x0F12, 0x0025);            //TVAR_ash_pGAS[515]
S5K5CAGX_write_cmos_sensor(0x0F12, 0x0042);            //TVAR_ash_pGAS[516]
S5K5CAGX_write_cmos_sensor(0x0F12, 0x0067);            //TVAR_ash_pGAS[517]
S5K5CAGX_write_cmos_sensor(0x0F12, 0x0099);            //TVAR_ash_pGAS[518]
S5K5CAGX_write_cmos_sensor(0x0F12, 0x00D8);            //TVAR_ash_pGAS[519]
S5K5CAGX_write_cmos_sensor(0x0F12, 0x00D3);            //TVAR_ash_pGAS[520]
S5K5CAGX_write_cmos_sensor(0x0F12, 0x00A3);            //TVAR_ash_pGAS[521]
S5K5CAGX_write_cmos_sensor(0x0F12, 0x0075);            //TVAR_ash_pGAS[522]
S5K5CAGX_write_cmos_sensor(0x0F12, 0x0053);            //TVAR_ash_pGAS[523]
S5K5CAGX_write_cmos_sensor(0x0F12, 0x0038);            //TVAR_ash_pGAS[524]
S5K5CAGX_write_cmos_sensor(0x0F12, 0x0029);            //TVAR_ash_pGAS[525]
S5K5CAGX_write_cmos_sensor(0x0F12, 0x0025);            //TVAR_ash_pGAS[526]
S5K5CAGX_write_cmos_sensor(0x0F12, 0x002B);            //TVAR_ash_pGAS[527]
S5K5CAGX_write_cmos_sensor(0x0F12, 0x003C);            //TVAR_ash_pGAS[528]
S5K5CAGX_write_cmos_sensor(0x0F12, 0x0059);            //TVAR_ash_pGAS[529]
S5K5CAGX_write_cmos_sensor(0x0F12, 0x007C);            //TVAR_ash_pGAS[530]
S5K5CAGX_write_cmos_sensor(0x0F12, 0x00AE);            //TVAR_ash_pGAS[531]
S5K5CAGX_write_cmos_sensor(0x0F12, 0x00E8);            //TVAR_ash_pGAS[532]
S5K5CAGX_write_cmos_sensor(0x0F12, 0x00F6);            //TVAR_ash_pGAS[533]
S5K5CAGX_write_cmos_sensor(0x0F12, 0x00C8);            //TVAR_ash_pGAS[534]
S5K5CAGX_write_cmos_sensor(0x0F12, 0x0099);            //TVAR_ash_pGAS[535]
S5K5CAGX_write_cmos_sensor(0x0F12, 0x0076);            //TVAR_ash_pGAS[536]
S5K5CAGX_write_cmos_sensor(0x0F12, 0x005E);            //TVAR_ash_pGAS[537]
S5K5CAGX_write_cmos_sensor(0x0F12, 0x0050);            //TVAR_ash_pGAS[538]
S5K5CAGX_write_cmos_sensor(0x0F12, 0x004C);            //TVAR_ash_pGAS[539]
S5K5CAGX_write_cmos_sensor(0x0F12, 0x004F);            //TVAR_ash_pGAS[540]
S5K5CAGX_write_cmos_sensor(0x0F12, 0x005F);            //TVAR_ash_pGAS[541]
S5K5CAGX_write_cmos_sensor(0x0F12, 0x007B);            //TVAR_ash_pGAS[542]
S5K5CAGX_write_cmos_sensor(0x0F12, 0x009D);            //TVAR_ash_pGAS[543]
S5K5CAGX_write_cmos_sensor(0x0F12, 0x00CE);            //TVAR_ash_pGAS[544]
S5K5CAGX_write_cmos_sensor(0x0F12, 0x0103);            //TVAR_ash_pGAS[545]
S5K5CAGX_write_cmos_sensor(0x0F12, 0x0123);            //TVAR_ash_pGAS[546]
S5K5CAGX_write_cmos_sensor(0x0F12, 0x00FB);            //TVAR_ash_pGAS[547]
S5K5CAGX_write_cmos_sensor(0x0F12, 0x00CB);            //TVAR_ash_pGAS[548]
S5K5CAGX_write_cmos_sensor(0x0F12, 0x00A7);            //TVAR_ash_pGAS[549]
S5K5CAGX_write_cmos_sensor(0x0F12, 0x0094);            //TVAR_ash_pGAS[550]
S5K5CAGX_write_cmos_sensor(0x0F12, 0x0087);            //TVAR_ash_pGAS[551]
S5K5CAGX_write_cmos_sensor(0x0F12, 0x0081);            //TVAR_ash_pGAS[552]
S5K5CAGX_write_cmos_sensor(0x0F12, 0x0084);            //TVAR_ash_pGAS[553]
S5K5CAGX_write_cmos_sensor(0x0F12, 0x0090);            //TVAR_ash_pGAS[554]
S5K5CAGX_write_cmos_sensor(0x0F12, 0x00AA);            //TVAR_ash_pGAS[555]
S5K5CAGX_write_cmos_sensor(0x0F12, 0x00CD);            //TVAR_ash_pGAS[556]
S5K5CAGX_write_cmos_sensor(0x0F12, 0x00FD);            //TVAR_ash_pGAS[557]
S5K5CAGX_write_cmos_sensor(0x0F12, 0x0123);            //TVAR_ash_pGAS[558]
S5K5CAGX_write_cmos_sensor(0x0F12, 0x0155);            //TVAR_ash_pGAS[559]
S5K5CAGX_write_cmos_sensor(0x0F12, 0x0128);            //TVAR_ash_pGAS[560]
S5K5CAGX_write_cmos_sensor(0x0F12, 0x00FF);            //TVAR_ash_pGAS[561]
S5K5CAGX_write_cmos_sensor(0x0F12, 0x00E0);            //TVAR_ash_pGAS[562]
S5K5CAGX_write_cmos_sensor(0x0F12, 0x00C9);            //TVAR_ash_pGAS[563]
S5K5CAGX_write_cmos_sensor(0x0F12, 0x00BC);            //TVAR_ash_pGAS[564]
S5K5CAGX_write_cmos_sensor(0x0F12, 0x00B9);            //TVAR_ash_pGAS[565]
S5K5CAGX_write_cmos_sensor(0x0F12, 0x00BC);            //TVAR_ash_pGAS[566]
S5K5CAGX_write_cmos_sensor(0x0F12, 0x00C6);            //TVAR_ash_pGAS[567]
S5K5CAGX_write_cmos_sensor(0x0F12, 0x00E2);            //TVAR_ash_pGAS[568]
S5K5CAGX_write_cmos_sensor(0x0F12, 0x0101);            //TVAR_ash_pGAS[569]
S5K5CAGX_write_cmos_sensor(0x0F12, 0x012A);            //TVAR_ash_pGAS[570]
S5K5CAGX_write_cmos_sensor(0x0F12, 0x0165);            //TVAR_ash_pGAS[571]
                                               //param_endTVAR_ash_pGAS
...
S5K5CAGX_write_cmos_sensor(0x0F12, 0x025F);            //awbb_GLocusR
S5K5CAGX_write_cmos_sensor(0x002A, 0x0D32);
S5K5CAGX_write_cmos_sensor(0x0F12, 0x0376);            //awbb_GLocusB
                                                //param_startTVAR_ash_AwbAshCord
S5K5CAGX_write_cmos_sensor(0x002A, 0x06B8);
S5K5CAGX_write_cmos_sensor(0x0F12, 0x00C0);            //TVAR_ash_AwbAshCord[0]
S5K5CAGX_write_cmos_sensor(0x0F12, 0x00E0);            //TVAR_ash_AwbAshCord[1]
S5K5CAGX_write_cmos_sensor(0x0F12, 0x00FA);            //TVAR_ash_AwbAshCord[2]
S5K5CAGX_write_cmos_sensor(0x0F12, 0x011D);            //TVAR_ash_AwbAshCord[3]
S5K5CAGX_write_cmos_sensor(0x0F12, 0x0144);            //TVAR_ash_AwbAshCord[4]
S5K5CAGX_write_cmos_sensor(0x0F12, 0x0173);            //TVAR_ash_AwbAshCord[5]
S5K5CAGX_write_cmos_sensor(0x0F12, 0x0180);            //TVAR_ash_AwbAshCord[6]
                                                //param_endTVAR_ash_AwbAshCord
...
S5K5CAGX_write_cmos_sensor(0x0F12, 0x010B);                //ash_CGrasAlphas[0]
S5K5CAGX_write_cmos_sensor(0x0F12, 0x0103);                //ash_CGrasAlphas[1]
S5K5CAGX_write_cmos_sensor(0x0F12, 0x00FC);                //ash_CGrasAlphas[2]
S5K5CAGX_write_cmos_sensor(0x0F12, 0x010C);                //ash_CGrasAlphas[3]
                                                //============================================================
                                                //End GAS
                                                //============================================================
                                                //White Balance
                                                //============================================================
                                                //param_startawbb_IndoorGrZones_m_BGrid
S5K5CAGX_write_cmos_sensor(0x002A, 0x0C48);
S5K5CAGX_write_cmos_sensor(0x0F12, 0x03C9);            //awbb_IndoorGrZones_m_BGrid[0]
S5K5CAGX_write_cmos_sensor(0x0F12, 0x040A);            //awbb_IndoorGrZones_m_BGrid[1]
S5K5CAGX_write_cmos_sensor(0x0F12, 0x038B);            //awbb_IndoorGrZones_m_BGrid[2]
S5K5CAGX_write_cmos_sensor(0x0F12, 0x0405);            //awbb_IndoorGrZones_m_BGrid[3]
S5K5CAGX_write_cmos_sensor(0x0F12, 0x0356);            //awbb_IndoorGrZones_m_BGrid[4]
S5K5CAGX_write_cmos_sensor(0x0F12, 0x0400);            //awbb_IndoorGrZones_m_BGrid[5]
S5K5CAGX_write_cmos_sensor(0x0F12, 0x0322);            //awbb_IndoorGrZones_m_BGrid[6]
S5K5CAGX_write_cmos_sensor(0x0F12, 0x03DF);            //awbb_IndoorGrZones_m_BGrid[7]
S5K5CAGX_write_cmos_sensor(0x0F12, 0x02E9);            //awbb_IndoorGrZones_m_BGrid[8]
S5K5CAGX_write_cmos_sensor(0x0F12, 0x03B0);            //awbb_IndoorGrZones_m_BGrid[9]
S5K5CAGX_write_cmos_sensor(0x0F12, 0x02B6);            //awbb_IndoorGrZones_m_BGrid[10]
S5K5CAGX_write_cmos_sensor(0x0F12, 0x0380);            //awbb_IndoorGrZones_m_BGrid[11]
S5K5CAGX_write_cmos_sensor(0x0F12, 0x0296);            //awbb_IndoorGrZones_m_BGrid[12]
S5K5CAGX_write_cmos_sensor(0x0F12, 0x034F);            //awbb_IndoorGrZones_m_BGrid[13]
S5K5CAGX_write_cmos_sensor(0x0F12, 0x027F);            //awbb_IndoorGrZones_m_BGrid[14]
S5K5CAGX_write_cmos_sensor(0x0F12, 0x031A);            //awbb_IndoorGrZones_m_BGrid[15]
S5K5CAGX_write_cmos_sensor(0x0F12, 0x026C);            //awbb_IndoorGrZones_m_BGrid[16]
S5K5CAGX_write_cmos_sensor(0x0F12, 0x02F5);            //awbb_IndoorGrZones_m_BGrid[17]
S5K5CAGX_write_cmos_sensor(0x0F12, 0x0256);            //awbb_IndoorGrZones_m_BGrid[18]
S5K5CAGX_write_cmos_sensor(0x0F12, 0x02DA);            //awbb_IndoorGrZones_m_BGrid[19]
S5K5CAGX_write_cmos_sensor(0x0F12, 0x0241);            //awbb_IndoorGrZones_m_BGrid[20]
S5K5CAGX_write_cmos_sensor(0x0F12, 0x02C4);            //awbb_IndoorGrZones_m_BGrid[21]
S5K5CAGX_write_cmos_sensor(0x0F12, 0x0228);            //awbb_IndoorGrZones_m_BGrid[22]
S5K5CAGX_write_cmos_sensor(0x0F12, 0x02AB);            //awbb_IndoorGrZones_m_BGrid[23]
S5K5CAGX_write_cmos_sensor(0x0F12, 0x0213);            //awbb_IndoorGrZones_m_BGrid[24]
S5K5CAGX_write_cmos_sensor(0x0F12, 0x0292);            //awbb_IndoorGrZones_m_BGrid[25]
S5K5CAGX_write_cmos_sensor(0x0F12, 0x01FF);            //awbb_IndoorGrZones_m_BGrid[26]
S5K5CAGX_write_cmos_sensor(0x0F12, 0x0278);            //awbb_IndoorGrZones_m_BGrid[27]
S5K5CAGX_write_cmos_sensor(0x0F12, 0x01F4);            //awbb_IndoorGrZones_m_BGrid[28]
S5K5CAGX_write_cmos_sensor(0x0F12, 0x025F);            //awbb_IndoorGrZones_m_BGrid[29]
S5K5CAGX_write_cmos_sensor(0x0F12, 0x0202);            //awbb_IndoorGrZones_m_BGrid[30]
S5K5CAGX_write_cmos_sensor(0x0F12, 0x0234);            //awbb_IndoorGrZones_m_BGrid[31]
...
S5K5CAGX_write_cmos_sensor(0x0F12, 0x0000);            //awbb_IndoorGrZones_m_BGrid[39]
                                                      //param_endawbb_IndoorGrZones_m_BGrid
S5K5CAGX_write_cmos_sensor(0x002A, 0x0C98);
S5K5CAGX_write_cmos_sensor(0x0F12, 0x0005);
S5K5CAGX_write_cmos_sensor(0x0F12, 0x0000);            //awbb_IndoorGrZones_m_GridStep
S5K5CAGX_write_cmos_sensor(0x002A, 0x0CA0);
S5K5CAGX_write_cmos_sensor(0x0F12, 0x00E8);
S5K5CAGX_write_cmos_sensor(0x0F12, 0x0000);            //awbb_IndoorGrZones_m_Boffs
                                                       //param_startawbb_LowBrGrZones_m_BGrid
...
S5K5CAGX_write_cmos_sensor(0x0F12, 0x0000);            //awbb_LowBrGrZones_m_BGrid[23]
                                                         //param_endawbb_LowBrGrZones_m_BGrid
S5K5CAGX_write_cmos_sensor(0x002A, 0x0D10);
S5K5CAGX_write_cmos_sensor(0x0F12, 0x0006);
S5K5CAGX_write_cmos_sensor(0x0F12, 0x0000);            //awbb_LowBrGrZones_m_GridStep
S5K5CAGX_write_cmos_sensor(0x002A, 0x0D18);
S5K5CAGX_write_cmos_sensor(0x0F12, 0x00AE);
S5K5CAGX_write_cmos_sensor(0x0F12, 0x0000);            //awbb_LowBrGrZones_m_Boffs
                                                        //param_startawbb_OutdoorGrZones_m_BGrid
S5K5CAGX_write_cmos_sensor(0x002A, 0x0CA4);
S5K5CAGX_write_cmos_sensor(0x0F12, 0x029A);            //awbb_OutdoorGrZones_m_BGrid[0]
S5K5CAGX_write_cmos_sensor(0x0F12, 0x02D4);            //awbb_OutdoorGrZones_m_BGrid[1]
S5K5CAGX_write_cmos_sensor(0x0F12, 0x028A);            //awbb_OutdoorGrZones_m_BGrid[2]
S5K5CAGX_write_cmos_sensor(0x0F12, 0x02D8);            //awbb_OutdoorGrZones_m_BGrid[3]
S5K5CAGX_write_cmos_sensor(0x0F12, 0x027C);            //awbb_OutdoorGrZones_m_BGrid[4]
S5K5CAGX_write_cmos_sensor(0x0F12, 0x02DE);            //awbb_OutdoorGrZones_m_BGrid[5]
S5K5CAGX_write_cmos_sensor(0x0F12, 0x0273);            //awbb_OutdoorGrZones_m_BGrid[6]
S5K5CAGX_write_cmos_sensor(0x0F12, 0x02D4);            //awbb_OutdoorGrZones_m_BGrid[7]
S5K5CAGX_write_cmos_sensor(0x0F12, 0x026E);            //awbb_OutdoorGrZones_m_BGrid[8]
S5K5CAGX_write_cmos_sensor(0x0F12, 0x02CA);            //awbb_OutdoorGrZones_m_BGrid[9]
S5K5CAGX_write_cmos_sensor(0x0F12, 0x026A);            //awbb_OutdoorGrZones_m_BGrid[10]
S5K5CAGX_write_cmos_sensor(0x0F12, 0x02C0);            //awbb_OutdoorGrZones_m_BGrid[11]
S5K5CAGX_write_cmos_sensor(0x0F12, 0x0268);            //awbb_OutdoorGrZones_m_BGrid[12]
S5K5CAGX_write_cmos_sensor(0x0F12, 0x02AE);            //awbb_OutdoorGrZones_m_BGrid[13]
S5K5CAGX_write_cmos_sensor(0x0F12, 0x0270);            //awbb_OutdoorGrZones_m_BGrid[14]
S5K5CAGX_write_cmos_sensor(0x0F12, 0x0296);            //awbb_OutdoorGrZones_m_BGrid[15]
...
S5K5CAGX_write_cmos_sensor(0x0F12, 0x0000);            //awbb_OutdoorGrZones_m_BGrid[23]
                                                        //param_endawbb_OutdoorGrZones_m_BGrid
S5K5CAGX_write_cmos_sensor(0x002A, 0x0CD4);
S5K5CAGX_write_cmos_sensor(0x0F12, 0x0004);  //0005
S5K5CAGX_write_cmos_sensor(0x0F12, 0x0000);            //awbb_OutdoorGrZones_m_GridStep
S5K5CAGX_write_cmos_sensor(0x002A, 0x0CD8);
S5K5CAGX_write_cmos_sensor(0x0F12, 0x0008);
S5K5CAGX_write_cmos_sensor(0x002A, 0x0CDC);
S5K5CAGX_write_cmos_sensor(0x0F12, 0x0204);  //0157              //01FE
                                                        //0F12    0000            //awbb_OutdoorGrZones_m_Boffs
                                                       //Low illumiantion
S5K5CAGX_write_cmos_sensor(0x002A, 0x0D1C);
S5K5CAGX_write_cmos_sensor(0x0F12, 0x037C);
S5K5CAGX_write_cmos_sensor(0x0F12, 0x0000);            //awbb_CrclLowT_R_c
S5K5CAGX_write_cmos_sensor(0x002A, 0x0D20);
S5K5CAGX_write_cmos_sensor(0x0F12, 0x0157);
S5K5CAGX_write_cmos_sensor(0x0F12, 0x0000);            //awbb_CrclLowT_B_c
S5K5CAGX_write_cmos_sensor(0x002A, 0x0D24);
S5K5CAGX_write_cmos_sensor(0x0F12, 0x3EB8);
S5K5CAGX_write_cmos_sensor(0x0F12, 0x0000);            //awbb_CrclLowT_Rad_c
                                                       //White,locus
...
S5K5CAGX_write_cmos_sensor(0x0F12, 0x0396);            //04A2            //awbb_MvEq_RBthresh
S5K5CAGX_write_cmos_sensor(0x002A, 0x0D5C);
S5K5CAGX_write_cmos_sensor(0x0F12, 0x0584);            //awbb_LowTempRB

                                                  //Grid Correction
                                                  //param_startawbb_GridCorr_R
S5K5CAGX_write_cmos_sensor(0x002A, 0x0DD4);
S5K5CAGX_write_cmos_sensor(0x0F12, 0x003C);            //awbb_GridCorr_R[0]
S5K5CAGX_write_cmos_sensor(0x0F12, 0x00b4);            //awbb_GridCorr_R[1]
S5K5CAGX_write_cmos_sensor(0x0F12, 0x0064);            //awbb_GridCorr_R[2]
S5K5CAGX_write_cmos_sensor(0x0F12, 0x0000);            //awbb_GridCorr_R[3]
S5K5CAGX_write_cmos_sensor(0x0F12, 0x0014);            //awbb_GridCorr_R[4]
S5K5CAGX_write_cmos_sensor(0x0F12, 0x0014);            //awbb_GridCorr_R[5]
S5K5CAGX_write_cmos_sensor(0x0F12, 0x003C);            //awbb_GridCorr_R[6]
S5K5CAGX_write_cmos_sensor(0x0F12, 0x00b4);            //awbb_GridCorr_R[7]
S5K5CAGX_write_cmos_sensor(0x0F12, 0x0064);            //awbb_GridCorr_R[8]
S5K5CAGX_write_cmos_sensor(0x0F12, 0x0000);            //awbb_GridCorr_R[9]
S5K5CAGX_write_cmos_sensor(0x0F12, 0x0014);            //awbb_GridCorr_R[10]
S5K5CAGX_write_cmos_sensor(0x0F12, 0x0014);            //awbb_GridCorr_R[11]
S5K5CAGX_write_cmos_sensor(0x0F12, 0x003C);            //awbb_GridCorr_R[12]
S5K5CAGX_write_cmos_sensor(0x0F12, 0x00b4);            //awbb_GridCorr_R[13]
S5K5CAGX_write_cmos_sensor(0x0F12, 0x0064);            //awbb_GridCorr_R[14]
S5K5CAGX_write_cmos_sensor(0x0F12, 0x0000);            //awbb_GridCorr_R[15]
S5K5CAGX_write_cmos_sensor(0x0F12, 0x0014);            //awbb_GridCorr_R[16]
S5K5CAGX_write_cmos_sensor(0x0F12, 0x0014);            //awbb_GridCorr_R[17]
                                                  //param_endawbb_GridCorr_R
                                                  //param_startawbb_GridCorr_B
S5K5CAGX_write_cmos_sensor(0x002A, 0x0DF8);
S5K5CAGX_write_cmos_sensor(0x0F12, 0xFFEC);            //awbb_GridCorr_B[0]
S5K5CAGX_write_cmos_sensor(0x0F12, 0xFFEC);            //awbb_GridCorr_B[1]
S5K5CAGX_write_cmos_sensor(0x0F12, 0x0078);            //awbb_GridCorr_B[2]
S5K5CAGX_write_cmos_sensor(0x0F12, 0xFFE2);            //awbb_GridCorr_B[3]
S5K5CAGX_write_cmos_sensor(0x0F12, 0xFFE2);            //awbb_GridCorr_B[4]
S5K5CAGX_write_cmos_sensor(0x0F12, 0xFFB0);            //awbb_GridCorr_B[5]
S5K5CAGX_write_cmos_sensor(0x0F12, 0xFFEC);            //awbb_GridCorr_B[6]
S5K5CAGX_write_cmos_sensor(0x0F12, 0xFFEC);            //awbb_GridCorr_B[7]
S5K5CAGX_write_cmos_sensor(0x0F12, 0x0078);            //awbb_GridCorr_B[8]
S5K5CAGX_write_cmos_sensor(0x0F12, 0xFFE2);            //awbb_GridCorr_B[9]
S5K5CAGX_write_cmos_sensor(0x0F12, 0xFFE2);            //awbb_GridCorr_B[10]
S5K5CAGX_write_cmos_sensor(0x0F12, 0xFFB0);            //awbb_GridCorr_B[11]
S5K5CAGX_write_cmos_sensor(0x0F12, 0xFFEC);            //awbb_GridCorr_B[12]
S5K5CAGX_write_cmos_sensor(0x0F12, 0xFFEC);            //awbb_GridCorr_B[13]
S5K5CAGX_write_cmos_sensor(0x0F12, 0x0078);            //awbb_GridCorr_B[14]
S5K5CAGX_write_cmos_sensor(0x0F12, 0xFFE2);            //awbb_GridCorr_B[15]
S5K5CAGX_write_cmos_sensor(0x0F12, 0xFFE2);            //awbb_GridCorr_B[16]
S5K5CAGX_write_cmos_sensor(0x0F12, 0xFFB0);            //awbb_GridCorr_B[17]
                                                 //param_endawbb_GridCorr_B
                                                 //param_startawbb_GridConst_1
S5K5CAGX_write_cmos_sensor(0x002A, 0x0E1C);
S5K5CAGX_write_cmos_sensor(0x0F12, 0x02D9);            //awbb_GridConst_1[0]
S5K5CAGX_write_cmos_sensor(0x0F12, 0x0357);            //awbb_GridConst_1[1]
S5K5CAGX_write_cmos_sensor(0x0F12, 0x03D1);            //awbb_GridConst_1[2]
                                                    //param_endawbb_GridConst_1
                                                    //param_startawbb_GridConst_2
S5K5CAGX_write_cmos_sensor(0x002A, 0x0E22);
S5K5CAGX_write_cmos_sensor(0x0F12, 0x0DE9);            //awbb_GridConst_2[0]
S5K5CAGX_write_cmos_sensor(0x0F12, 0x0EDD);            //awbb_GridConst_2[1]
S5K5CAGX_write_cmos_sensor(0x0F12, 0x0F42);            //awbb_GridConst_2[2]
S5K5CAGX_write_cmos_sensor(0x0F12, 0x0F54);            //awbb_GridConst_2[3]
S5K5CAGX_write_cmos_sensor(0x0F12, 0x0FAE);            //awbb_GridConst_2[4]
S5K5CAGX_write_cmos_sensor(0x0F12, 0x1011);            //awbb_GridConst_2[5]
                                                   //param_endawbb_GridConst_2
S5K5CAGX_write_cmos_sensor(0x002A, 0x0E2E);
S5K5CAGX_write_cmos_sensor(0x0F12, 0x00BA);            //awbb_GridCoeff_R_1
S5K5CAGX_write_cmos_sensor(0x0F12, 0x00AF);            //awbb_GridCoeff_B_1
S5K5CAGX_write_cmos_sensor(0x0F12, 0x0049);            //awbb_GridCoeff_R_2
S5K5CAGX_write_cmos_sensor(0x0F12, 0x00F5);            //awbb_GridCoeff_B_2
...
S5K5CAGX_write_cmos_sensor(0x0F12, 0x010E);            //lt_uLimitHigh             
S5K5CAGX_write_cmos_sensor(0x0F12, 0x00F5);            //lt_uLimitLow              
                                                 //disable contrast, enable illumination
S5K5CAGX_write_cmos_sensor(0x002A, 0x0F76);                             
S5K5CAGX_write_cmos_sensor(0x0F12, 0x0001);              //                          

S5K5CAGX_write_cmos_sensor(0x002A, 0x1034);                             
S5K5CAGX_write_cmos_sensor(0x0F12, 0x00C0);            //SARR_IllumType[0]         
S5K5CAGX_write_cmos_sensor(0x0F12, 0x00E0);              //SARR_IllumType[1]        
S5K5CAGX_write_cmos_sensor(0x0F12, 0x00F0);              //SARR_IllumType[2]        
S5K5CAGX_write_cmos_sensor(0x0F12, 0x0129);              //SARR_IllumType[3]        
S5K5CAGX_write_cmos_sensor(0x0F12, 0x0156);              //SARR_IllumType[4]        
S5K5CAGX_write_cmos_sensor(0x0F12, 0x017F);              //SARR_IllumType[5]        
S5K5CAGX_write_cmos_sensor(0x0F12, 0x018F);              //SARR_IllumType[6]        

S5K5CAGX_write_cmos_sensor(0x002A, 0x1042);                             
S5K5CAGX_write_cmos_sensor(0x0F12, 0x0120);                //SARR_IllumTypeF[0]      
S5K5CAGX_write_cmos_sensor(0x0F12, 0x0120);                //SARR_IllumTypeF[1]      
S5K5CAGX_write_cmos_sensor(0x0F12, 0x0120);                //SARR_IllumTypeF[2]      
S5K5CAGX_write_cmos_sensor(0x0F12, 0x0100);                //SARR_IllumTypeF[3]      
...
S5K5CAGX_write_cmos_sensor(0x0F12, 0x0046);              //TVAR_ae_BrAve
                                                //AE Weight
S5K5CAGX_write_cmos_sensor(0x0028, 0x7000);
S5K5CAGX_write_cmos_sensor(0x002A, 0x0f7e);                //AE weight/
S5K5CAGX_write_cmos_sensor(0x0F12, 0x0101);            //0000
S5K5CAGX_write_cmos_sensor(0x0F12, 0x0101);            //0000
S5K5CAGX_write_cmos_sensor(0x0F12, 0x0101);            //0000
S5K5CAGX_write_cmos_sensor(0x0F12, 0x0101);            //0000
S5K5CAGX_write_cmos_sensor(0x0F12, 0x0101);            //0101
S5K5CAGX_write_cmos_sensor(0x0F12, 0x0101);            //0101
S5K5CAGX_write_cmos_sensor(0x0F12, 0x0101);            //0101
S5K5CAGX_write_cmos_sensor(0x0F12, 0x0101);            //0101
S5K5CAGX_write_cmos_sensor(0x0F12, 0x0101);            //0101
S5K5CAGX_write_cmos_sensor(0x0F12, 0x0303);            //0101
S5K5CAGX_write_cmos_sensor(0x0F12, 0x0303);            //0101
S5K5CAGX_write_cmos_sensor(0x0F12, 0x0101);            //0101
S5K5CAGX_write_cmos_sensor(0x0F12, 0x0101);            //0101
S5K5CAGX_write_cmos_sensor(0x0F12, 0x0303);            //0401
S5K5CAGX_write_cmos_sensor(0x0F12, 0x0303);            //0104
S5K5CAGX_write_cmos_sensor(0x0F12, 0x0101);            //0101
S5K5CAGX_write_cmos_sensor(0x0F12, 0x0101);            //0101
S5K5CAGX_write_cmos_sensor(0x0F12, 0x0303);            //0401
S5K5CAGX_write_cmos_sensor(0x0F12, 0x0303);            //0104
S5K5CAGX_write_cmos_sensor(0x0F12, 0x0101);            //0101
S5K5CAGX_write_cmos_sensor(0x0F12, 0x0101);            //0101
S5K5CAGX_write_cmos_sensor(0x0F12, 0x0303);            //0201
S5K5CAGX_write_cmos_sensor(0x0F12, 0x0303);            //0102
S5K5CAGX_write_cmos_sensor(0x0F12, 0x0101);            //0101
S5K5CAGX_write_cmos_sensor(0x0F12, 0x0101);            //0101
S5K5CAGX_write_cmos_sensor(0x0F12, 0x0101);            //0201
S5K5CAGX_write_cmos_sensor(0x0F12, 0x0101);            //0102
S5K5CAGX_write_cmos_sensor(0x0F12, 0x0101);            //0101
S5K5CAGX_write_cmos_sensor(0x0F12, 0x0101);            //0101
S5K5CAGX_write_cmos_sensor(0x0F12, 0x0101);            //0101
S5K5CAGX_write_cmos_sensor(0x0F12, 0x0101);            //0101
...
S5K5CAGX_write_cmos_sensor(0x0F12, 0x0000);            //0000             //#SARR_usDualGammaLutRGBIndoor[0][0]0000
S5K5CAGX_write_cmos_sensor(0x0F12, 0x0008);            //0008             //#SARR_usDualGammaLutRGBIndoor[0][1]0008
S5K5CAGX_write_cmos_sensor(0x0F12, 0x0013);            //0013             //#SARR_usDualGammaLutRGBIndoor[0][2]0013
S5K5CAGX_write_cmos_sensor(0x0F12, 0x002C);            //002C             //#SARR_usDualGammaLutRGBIndoor[0][3]002C
S5K5CAGX_write_cmos_sensor(0x0F12, 0x0062);            //0061             //#SARR_usDualGammaLutRGBIndoor[0][4]0061
S5K5CAGX_write_cmos_sensor(0x0F12, 0x00CD);            //00C8             //#SARR_usDualGammaLutRGBIndoor[0][5]00C8
S5K5CAGX_write_cmos_sensor(0x0F12, 0x0129);            //0113             //#SARR_usDualGammaLutRGBIndoor[0][6]0113
S5K5CAGX_write_cmos_sensor(0x0F12, 0x0151);            //0132             //#SARR_usDualGammaLutRGBIndoor[0][7]0132
S5K5CAGX_write_cmos_sensor(0x0F12, 0x0174);            //014C             //#SARR_usDualGammaLutRGBIndoor[0][8]014C
S5K5CAGX_write_cmos_sensor(0x0F12, 0x01AA);            //0179             //#SARR_usDualGammaLutRGBIndoor[0][9]0179
S5K5CAGX_write_cmos_sensor(0x0F12, 0x01D7);            //01A4             //#SARR_usDualGammaLutRGBIndoor[0][10]  01A4
S5K5CAGX_write_cmos_sensor(0x0F12, 0x01FE);            //01CD             //#SARR_usDualGammaLutRGBIndoor[0][11]  01CD
S5K5CAGX_write_cmos_sensor(0x0F12, 0x0221);            //01F4             //#SARR_usDualGammaLutRGBIndoor[0][12]  01F4
S5K5CAGX_write_cmos_sensor(0x0F12, 0x025D);            //0239             //#SARR_usDualGammaLutRGBIndoor[0][13]  0239
S5K5CAGX_write_cmos_sensor(0x0F12, 0x0291);            //0278             //#SARR_usDualGammaLutRGBIndoor[0][14]  0278
S5K5CAGX_write_cmos_sensor(0x0F12, 0x02EB);            //02E0             //#SARR_usDualGammaLutRGBIndoor[0][15]  02E0
S5K5CAGX_write_cmos_sensor(0x0F12, 0x033A);            //0333             //#SARR_usDualGammaLutRGBIndoor[0][16]  0333
S5K5CAGX_write_cmos_sensor(0x0F12, 0x0380);            //037B             //#SARR_usDualGammaLutRGBIndoor[0][17]  037B
S5K5CAGX_write_cmos_sensor(0x0F12, 0x03C2);            //03BF             //#SARR_usDualGammaLutRGBIndoor[0][18]  03BF
S5K5CAGX_write_cmos_sensor(0x0F12, 0x03FF);            //03FF             //#SARR_usDualGammaLutRGBIndoor[0][19]  03FF
S5K5CAGX_write_cmos_sensor(0x0F12, 0x0000);            //0000             //#SARR_usDualGammaLutRGBIndoor[1][0]0000
S5K5CAGX_write_cmos_sensor(0x0F12, 0x0008);            //0008             //#SARR_usDualGammaLutRGBIndoor[1][1]0008
S5K5CAGX_write_cmos_sensor(0x0F12, 0x0013);            //0013             //#SARR_usDualGammaLutRGBIndoor[1][2]0013
S5K5CAGX_write_cmos_sensor(0x0F12, 0x002C);            //002C             //#SARR_usDualGammaLutRGBIndoor[1][3]002C
S5K5CAGX_write_cmos_sensor(0x0F12, 0x0062);            //0061             //#SARR_usDualGammaLutRGBIndoor[1][4]0061
S5K5CAGX_write_cmos_sensor(0x0F12, 0x00CD);            //00C8             //#SARR_usDualGammaLutRGBIndoor[1][5]00C8
S5K5CAGX_write_cmos_sensor(0x0F12, 0x0129);            //0113             //#SARR_usDualGammaLutRGBIndoor[1][6]0113
S5K5CAGX_write_cmos_sensor(0x0F12, 0x0151);            //0132             //#SARR_usDualGammaLutRGBIndoor[1][7]0132
S5K5CAGX_write_cmos_sensor(0x0F12, 0x0174);            //014C             //#SARR_usDualGammaLutRGBIndoor[1][8]014C
S5K5CAGX_write_cmos_sensor(0x0F12, 0x01AA);            //0179             //#SARR_usDualGammaLutRGBIndoor[1][9]0179
S5K5CAGX_write_cmos_sensor(0x0F12, 0x01D7);            //01A4             //#SARR_usDualGammaLutRGBIndoor[1][10]  01A4
S5K5CAGX_write_cmos_sensor(0x0F12, 0x01FE);            //01CD             //#SARR_usDualGammaLutRGBIndoor[1][11]  01CD
S5K5CAGX_write_cmos_sensor(0x0F12, 0x0221);            //01F4             //#SARR_usDualGammaLutRGBIndoor[1][12]  01F4
S5K5CAGX_write_cmos_sensor(0x0F12, 0x025D);            //0239             //#SARR_usDualGammaLutRGBIndoor[1][13]  0239
S5K5CAGX_write_cmos_sensor(0x0F12, 0x0291);            //0278             //#SARR_usDualGammaLutRGBIndoor[1][14]  0278
S5K5CAGX_write_cmos_sensor(0x0F12, 0x02EB);            //02E0             //#SARR_usDualGammaLutRGBIndoor[1][15]  02E0
S5K5CAGX_write_cmos_sensor(0x0F12, 0x033A);            //0333             //#SARR_usDualGammaLutRGBIndoor[1][16]  0333
S5K5CAGX_write_cmos_sensor(0x0F12, 0x0380);            //037B             //#SARR_usDualGammaLutRGBIndoor[1][17]  037B
S5K5CAGX_write_cmos_sensor(0x0F12, 0x03C2);            //03BF             //#SARR_usDualGammaLutRGBIndoor[1][18]  03BF
S5K5CAGX_write_cmos_sensor(0x0F12, 0x03FF);            //03FF             //#SARR_usDualGammaLutRGBIndoor[1][19]  03FF
S5K5CAGX_write_cmos_sensor(0x0F12, 0x0000);            //0000             //#SARR_usDualGammaLutRGBIndoor[2][0]0000
S5K5CAGX_write_cmos_sensor(0x0F12, 0x0008);            //0008             //#SARR_usDualGammaLutRGBIndoor[2][1]0008
S5K5CAGX_write_cmos_sensor(0x0F12, 0x0013);            //0013             //#SARR_usDualGammaLutRGBIndoor[2][2]0013
S5K5CAGX_write_cmos_sensor(0x0F12, 0x002C);            //002C             //#SARR_usDualGammaLutRGBIndoor[2][3]002C
S5K5CAGX_write_cmos_sensor(0x0F12, 0x0062);            //0061             //#SARR_usDualGammaLutRGBIndoor[2][4]0061
S5K5CAGX_write_cmos_sensor(0x0F12, 0x00CD);            //00C8             //#SARR_usDualGammaLutRGBIndoor[2][5]00C8
S5K5CAGX_write_cmos_sensor(0x0F12, 0x0129);            //0113             //#SARR_usDualGammaLutRGBIndoor[2][6]0113
S5K5CAGX_write_cmos_sensor(0x0F12, 0x0151);            //0132             //#SARR_usDualGammaLutRGBIndoor[2][7]0132
S5K5CAGX_write_cmos_sensor(0x0F12, 0x0174);            //014C             //#SARR_usDualGammaLutRGBIndoor[2][8]014C
S5K5CAGX_write_cmos_sensor(0x0F12, 0x01AA);            //0179             //#SARR_usDualGammaLutRGBIndoor[2][9]0179
S5K5CAGX_write_cmos_sensor(0x0F12, 0x01D7);            //01A4             //#SARR_usDualGammaLutRGBIndoor[2][10]  01A4
S5K5CAGX_write_cmos_sensor(0x0F12, 0x01FE);            //01CD             //#SARR_usDualGammaLutRGBIndoor[2][11]  01CD
S5K5CAGX_write_cmos_sensor(0x0F12, 0x0221);            //01F4             //#SARR_usDualGammaLutRGBIndoor[2][12]  01F4
S5K5CAGX_write_cmos_sensor(0x0F12, 0x025D);            //0239             //#SARR_usDualGammaLutRGBIndoor[2][13]  0239
S5K5CAGX_write_cmos_sensor(0x0F12, 0x0291);            //0278             //#SARR_usDualGammaLutRGBIndoor[2][14]  0278
S5K5CAGX_write_cmos_sensor(0x0F12, 0x02EB);            //02E0             //#SARR_usDualGammaLutRGBIndoor[2][15]  02E0
S5K5CAGX_write_cmos_sensor(0x0F12, 0x033A);            //0333             //#SARR_usDualGammaLutRGBIndoor[2][16]  0333
S5K5CAGX_write_cmos_sensor(0x0F12, 0x0380);            //037B             //#SARR_usDualGammaLutRGBIndoor[2][17]  037B
S5K5CAGX_write_cmos_sensor(0x0F12, 0x03C2);            //03BF             //#SARR_usDualGammaLutRGBIndoor[2][18]  03BF
S5K5CAGX_write_cmos_sensor(0x0F12, 0x03FF);            //03FF             //#SARR_usDualGammaLutRGBIndoor[2][19]  03FF

S5K5CAGX_write_cmos_sensor(0x002A, 0x3300);
S5K5CAGX_write_cmos_sensor(0x0F12, 0x0000);            //0000             //#SARR_usDualGammaLutRGBOutdoor[0][0]0000
S5K5CAGX_write_cmos_sensor(0x0F12, 0x0008);            //0008             //#SARR_usDualGammaLutRGBOutdoor[0][1]0008
S5K5CAGX_write_cmos_sensor(0x0F12, 0x0013);            //0013             //#SARR_usDualGammaLutRGBOutdoor[0][2]0013
S5K5CAGX_write_cmos_sensor(0x0F12, 0x002C);            //002C             //#SARR_usDualGammaLutRGBOutdoor[0][3]002C
S5K5CAGX_write_cmos_sensor(0x0F12, 0x0062);            //0061             //#SARR_usDualGammaLutRGBOutdoor[0][4]0061
S5K5CAGX_write_cmos_sensor(0x0F12, 0x00CD);            //00C8             //#SARR_usDualGammaLutRGBOutdoor[0][5]00C8
S5K5CAGX_write_cmos_sensor(0x0F12, 0x0129);            //0113             //#SARR_usDualGammaLutRGBOutdoor[0][6]0113
S5K5CAGX_write_cmos_sensor(0x0F12, 0x0151);            //0132             //#SARR_usDualGammaLutRGBOutdoor[0][7]0132
S5K5CAGX_write_cmos_sensor(0x0F12, 0x0174);            //014C             //#SARR_usDualGammaLutRGBOutdoor[0][8]014C
S5K5CAGX_write_cmos_sensor(0x0F12, 0x01AA);            //0179             //#SARR_usDualGammaLutRGBOutdoor[0][9]0179
S5K5CAGX_write_cmos_sensor(0x0F12, 0x01D7);            //01A4             //#SARR_usDualGammaLutRGBOutdoor[0][10]01A4
S5K5CAGX_write_cmos_sensor(0x0F12, 0x01FE);            //01CD             //#SARR_usDualGammaLutRGBOutdoor[0][11]01CD
S5K5CAGX_write_cmos_sensor(0x0F12, 0x0221);            //01F4             //#SARR_usDualGammaLutRGBOutdoor[0][12]01F4
S5K5CAGX_write_cmos_sensor(0x0F12, 0x025D);            //0239             //#SARR_usDualGammaLutRGBOutdoor[0][13]0239
S5K5CAGX_write_cmos_sensor(0x0F12, 0x0291);            //0278             //#SARR_usDualGammaLutRGBOutdoor[0][14]0278
S5K5CAGX_write_cmos_sensor(0x0F12, 0x02EB);            //02E0             //#SARR_usDualGammaLutRGBOutdoor[0][15]02E0
S5K5CAGX_write_cmos_sensor(0x0F12, 0x033A);            //0333             //#SARR_usDualGammaLutRGBOutdoor[0][16]0333
S5K5CAGX_write_cmos_sensor(0x0F12, 0x0380);            //037B             //#SARR_usDualGammaLutRGBOutdoor[0][17]037B
S5K5CAGX_write_cmos_sensor(0x0F12, 0x03C2);            //03BF             //#SARR_usDualGammaLutRGBOutdoor[0][18]03BF
S5K5CAGX_write_cmos_sensor(0x0F12, 0x03FF);            //03FF             //#SARR_usDualGammaLutRGBOutdoor[0][19]03FF
S5K5CAGX_write_cmos_sensor(0x0F12, 0x0000);            //0000             //#SARR_usDualGammaLutRGBOutdoor[1][0]0000
S5K5CAGX_write_cmos_sensor(0x0F12, 0x0008);            //0008             //#SARR_usDualGammaLutRGBOutdoor[1][1]0008
S5K5CAGX_write_cmos_sensor(0x0F12, 0x0013);            //0013             //#SARR_usDualGammaLutRGBOutdoor[1][2]0013
S5K5CAGX_write_cmos_sensor(0x0F12, 0x002C);            //002C             //#SARR_usDualGammaLutRGBOutdoor[1][3]002C
S5K5CAGX_write_cmos_sensor(0x0F12, 0x0062);            //0061             //#SARR_usDualGammaLutRGBOutdoor[1][4]0061
S5K5CAGX_write_cmos_sensor(0x0F12, 0x00CD);            //00C8             //#SARR_usDualGammaLutRGBOutdoor[1][5]00C8
S5K5CAGX_write_cmos_sensor(0x0F12, 0x0129);            //0113             //#SARR_usDualGammaLutRGBOutdoor[1][6]0113
S5K5CAGX_write_cmos_sensor(0x0F12, 0x0151);            //0132             //#SARR_usDualGammaLutRGBOutdoor[1][7]0132
S5K5CAGX_write_cmos_sensor(0x0F12, 0x0174);            //014C             //#SARR_usDualGammaLutRGBOutdoor[1][8]014C
S5K5CAGX_write_cmos_sensor(0x0F12, 0x01AA);            //0179             //#SARR_usDualGammaLutRGBOutdoor[1][9]0179
S5K5CAGX_write_cmos_sensor(0x0F12, 0x01D7);            //01A4             //#SARR_usDualGammaLutRGBOutdoor[1][10]01A4
S5K5CAGX_write_cmos_sensor(0x0F12, 0x01FE);            //01CD             //#SARR_usDualGammaLutRGBOutdoor[1][11]01CD
S5K5CAGX_write_cmos_sensor(0x0F12, 0x0221);            //01F4             //#SARR_usDualGammaLutRGBOutdoor[1][12]01F4
S5K5CAGX_write_cmos_sensor(0x0F12, 0x025D);            //0239             //#SARR_usDualGammaLutRGBOutdoor[1][13]0239
S5K5CAGX_write_cmos_sensor(0x0F12, 0x0291);            //0278             //#SARR_usDualGammaLutRGBOutdoor[1][14]0278
S5K5CAGX_write_cmos_sensor(0x0F12, 0x02EB);            //02E0             //#SARR_usDualGammaLutRGBOutdoor[1][15]02E0
S5K5CAGX_write_cmos_sensor(0x0F12, 0x033A);            //0333             //#SARR_usDualGammaLutRGBOutdoor[1][16]0333
S5K5CAGX_write_cmos_sensor(0x0F12, 0x0380);            //037B             //#SARR_usDualGammaLutRGBOutdoor[1][17]037B
S5K5CAGX_write_cmos_sensor(0x0F12, 0x03C2);            //03BF             //#SARR_usDualGammaLutRGBOutdoor[1][18]03BF
S5K5CAGX_write_cmos_sensor(0x0F12, 0x03FF);            //03FF             //#SARR_usDualGammaLutRGBOutdoor[1][19]03FF
S5K5CAGX_write_cmos_sensor(0x0F12, 0x0000);            //0000             //#SARR_usDualGammaLutRGBOutdoor[2][0]0000
S5K5CAGX_write_cmos_sensor(0x0F12, 0x0008);            //0008             //#SARR_usDualGammaLutRGBOutdoor[2][1]0008
S5K5CAGX_write_cmos_sensor(0x0F12, 0x0013);            //0013             //#SARR_usDualGammaLutRGBOutdoor[2][2]0013
S5K5CAGX_write_cmos_sensor(0x0F12, 0x002C);            //002C             //#SARR_usDualGammaLutRGBOutdoor[2][3]002C
S5K5CAGX_write_cmos_sensor(0x0F12, 0x0062);            //0061             //#SARR_usDualGammaLutRGBOutdoor[2][4]0061
S5K5CAGX_write_cmos_sensor(0x0F12, 0x00CD);            //00C8             //#SARR_usDualGammaLutRGBOutdoor[2][5]00C8
S5K5CAGX_write_cmos_sensor(0x0F12, 0x0129);            //0113             //#SARR_usDualGammaLutRGBOutdoor[2][6]0113
S5K5CAGX_write_cmos_sensor(0x0F12, 0x0151);            //0132             //#SARR_usDualGammaLutRGBOutdoor[2][7]0132
S5K5CAGX_write_cmos_sensor(0x0F12, 0x0174);            //014C             //#SARR_usDualGammaLutRGBOutdoor[2][8]014C
S5K5CAGX_write_cmos_sensor(0x0F12, 0x01AA);            //0179             //#SARR_usDualGammaLutRGBOutdoor[2][9]0179
S5K5CAGX_write_cmos_sensor(0x0F12, 0x01D7);            //01A4             //#SARR_usDualGammaLutRGBOutdoor[2][10]01A4
S5K5CAGX_write_cmos_sensor(0x0F12, 0x01FE);            //01CD             //#SARR_usDualGammaLutRGBOutdoor[2][11]01CD
S5K5CAGX_write_cmos_sensor(0x0F12, 0x0221);            //01F4             //#SARR_usDualGammaLutRGBOutdoor[2][12]01F4
S5K5CAGX_write_cmos_sensor(0x0F12, 0x025D);            //0239             //#SARR_usDualGammaLutRGBOutdoor[2][13]0239
S5K5CAGX_write_cmos_sensor(0x0F12, 0x0291);            //0278             //#SARR_usDualGammaLutRGBOutdoor[2][14]0278
S5K5CAGX_write_cmos_sensor(0x0F12, 0x02EB);            //02E0             //#SARR_usDualGammaLutRGBOutdoor[2][15]02E0
S5K5CAGX_write_cmos_sensor(0x0F12, 0x033A);            //0333             //#SARR_usDualGammaLutRGBOutdoor[2][16]0333
S5K5CAGX_write_cmos_sensor(0x0F12, 0x0380);            //037B             //#SARR_usDualGammaLutRGBOutdoor[2][17]037B
S5K5CAGX_write_cmos_sensor(0x0F12, 0x03C2);            //03BF             //#SARR_usDualGammaLutRGBOutdoor[2][18]03BF
S5K5CAGX_write_cmos_sensor(0x0F12, 0x03FF);            //03FF             //#SARR_usDualGammaLutRGBOutdoor[2][19]03FF

                                                    //============================================================
                                                    //CCM
                                                    //============================================================
S5K5CAGX_write_cmos_sensor(0x002A, 0x06A6);
S5K5CAGX_write_cmos_sensor(0x0F12, 0x00C0);                //SARR_AwbCcmCord[0]
S5K5CAGX_write_cmos_sensor(0x0F12, 0x00F8);                //SARR_AwbCcmCord[1]
S5K5CAGX_write_cmos_sensor(0x0F12, 0x0112);                //SARR_AwbCcmCord[2]
S5K5CAGX_write_cmos_sensor(0x0F12, 0x014A);                //SARR_AwbCcmCord[3]
S5K5CAGX_write_cmos_sensor(0x0F12, 0x0156);                //SARR_AwbCcmCord[4]
S5K5CAGX_write_cmos_sensor(0x0F12, 0x017F);                //SARR_AwbCcmCord[5]

                                               //param_startTVAR_wbt_pBaseCcms
                                               // Horizon
S5K5CAGX_write_cmos_sensor(0x002A, 0x33A4);
S5K5CAGX_write_cmos_sensor(0x0F12, 0x01A5);                //TVAR_wbt_pBaseCcms[0]
S5K5CAGX_write_cmos_sensor(0x0F12, 0xFF50);                //TVAR_wbt_pBaseCcms[1]
S5K5CAGX_write_cmos_sensor(0x0F12, 0xFFA7);                //TVAR_wbt_pBaseCcms[2]
S5K5CAGX_write_cmos_sensor(0x0F12, 0xFEC9);                //TVAR_wbt_pBaseCcms[3]
S5K5CAGX_write_cmos_sensor(0x0F12, 0x02B5);                        //TVAR_wbt_pBaseCcms[4]
S5K5CAGX_write_cmos_sensor(0x0F12, 0xFEE2);                //TVAR_wbt_pBaseCcms[5]
S5K5CAGX_write_cmos_sensor(0x0F12, 0xFF9C);                //TVAR_wbt_pBaseCcms[6]
S5K5CAGX_write_cmos_sensor(0x0F12, 0x0023);                //TVAR_wbt_pBaseCcms[7]
S5K5CAGX_write_cmos_sensor(0x0F12, 0x02D3);                //TVAR_wbt_pBaseCcms[8]
S5K5CAGX_write_cmos_sensor(0x0F12, 0x0297);                //TVAR_wbt_pBaseCcms[9]
S5K5CAGX_write_cmos_sensor(0x0F12, 0x01C9);                //TVAR_wbt_pBaseCcms[10]
S5K5CAGX_write_cmos_sensor(0x0F12, 0xFDAD);                //TVAR_wbt_pBaseCcms[11]
S5K5CAGX_write_cmos_sensor(0x0F12, 0x00EF);                //TVAR_wbt_pBaseCcms[12]
S5K5CAGX_write_cmos_sensor(0x0F12, 0xFEF9);                //TVAR_wbt_pBaseCcms[13]
S5K5CAGX_write_cmos_sensor(0x0F12, 0x01B2);                //TVAR_wbt_pBaseCcms[14]
S5K5CAGX_write_cmos_sensor(0x0F12, 0xFE93);                //TVAR_wbt_pBaseCcms[15]
S5K5CAGX_write_cmos_sensor(0x0F12, 0x01E1);                //TVAR_wbt_pBaseCcms[16]
S5K5CAGX_write_cmos_sensor(0x0F12, 0x0139);                //TVAR_wbt_pBaseCcms[17]
                                                 //inca
S5K5CAGX_write_cmos_sensor(0x0F12, 0x01A5);                 //TVAR_wbt_pBaseCcms[18]
S5K5CAGX_write_cmos_sensor(0x0F12, 0xFF50);                 //TVAR_wbt_pBaseCcms[19]
S5K5CAGX_write_cmos_sensor(0x0F12, 0xFFA7);                 //TVAR_wbt_pBaseCcms[20]
S5K5CAGX_write_cmos_sensor(0x0F12, 0xFEC9);                 //TVAR_wbt_pBaseCcms[21]
S5K5CAGX_write_cmos_sensor(0x0F12, 0x02B5);                 //TVAR_wbt_pBaseCcms[22]
S5K5CAGX_write_cmos_sensor(0x0F12, 0xFEE2);                 //TVAR_wbt_pBaseCcms[23]
S5K5CAGX_write_cmos_sensor(0x0F12, 0xFF9C);                 //TVAR_wbt_pBaseCcms[24]
S5K5CAGX_write_cmos_sensor(0x0F12, 0x0023);                 //TVAR_wbt_pBaseCcms[25]
S5K5CAGX_write_cmos_sensor(0x0F12, 0x02D3);                 //TVAR_wbt_pBaseCcms[26]
S5K5CAGX_write_cmos_sensor(0x0F12, 0x0297);                 //TVAR_wbt_pBaseCcms[27]
S5K5CAGX_write_cmos_sensor(0x0F12, 0x01C9);                 //TVAR_wbt_pBaseCcms[28]
S5K5CAGX_write_cmos_sensor(0x0F12, 0xFDAD);                 //TVAR_wbt_pBaseCcms[29]
S5K5CAGX_write_cmos_sensor(0x0F12, 0x00EF);                 //TVAR_wbt_pBaseCcms[30]
S5K5CAGX_write_cmos_sensor(0x0F12, 0xFEF9);                 //TVAR_wbt_pBaseCcms[31]
S5K5CAGX_write_cmos_sensor(0x0F12, 0x01B2);                 //TVAR_wbt_pBaseCcms[32]
S5K5CAGX_write_cmos_sensor(0x0F12, 0xFE93);                 //TVAR_wbt_pBaseCcms[33]
S5K5CAGX_write_cmos_sensor(0x0F12, 0x01E1);                 //TVAR_wbt_pBaseCcms[34]
S5K5CAGX_write_cmos_sensor(0x0F12, 0x0139);                 //TVAR_wbt_pBaseCcms[35]
                                                  //WW
S5K5CAGX_write_cmos_sensor(0x0F12, 0x0253);                  //TVAR_wbt_pBaseCcms[36]
S5K5CAGX_write_cmos_sensor(0x0F12, 0xFF59);                  //TVAR_wbt_pBaseCcms[37]
S5K5CAGX_write_cmos_sensor(0x0F12, 0xFF87);                  //TVAR_wbt_pBaseCcms[38]
S5K5CAGX_write_cmos_sensor(0x0F12, 0xFF27);                  //TVAR_wbt_pBaseCcms[39]
S5K5CAGX_write_cmos_sensor(0x0F12, 0x027B);                  //TVAR_wbt_pBaseCcms[40]
S5K5CAGX_write_cmos_sensor(0x0F12, 0xFF0B);                  //TVAR_wbt_pBaseCcms[41]
S5K5CAGX_write_cmos_sensor(0x0F12, 0xFFA9);                  //TVAR_wbt_pBaseCcms[42]
S5K5CAGX_write_cmos_sensor(0x0F12, 0xFFA6);                  //TVAR_wbt_pBaseCcms[43]
S5K5CAGX_write_cmos_sensor(0x0F12, 0x024D);                  //TVAR_wbt_pBaseCcms[44]
S5K5CAGX_write_cmos_sensor(0x0F12, 0x01A1);                  //TVAR_wbt_pBaseCcms[45]
S5K5CAGX_write_cmos_sensor(0x0F12, 0x011D);                  //TVAR_wbt_pBaseCcms[46]
S5K5CAGX_write_cmos_sensor(0x0F12, 0xFEC9);                  //TVAR_wbt_pBaseCcms[47]
S5K5CAGX_write_cmos_sensor(0x0F12, 0x01F1);                  //TVAR_wbt_pBaseCcms[48]
S5K5CAGX_write_cmos_sensor(0x0F12, 0xFF13);                  //TVAR_wbt_pBaseCcms[49]
S5K5CAGX_write_cmos_sensor(0x0F12, 0x017F);                  //TVAR_wbt_pBaseCcms[50]
S5K5CAGX_write_cmos_sensor(0x0F12, 0xFE44);                  //TVAR_wbt_pBaseCcms[51]
S5K5CAGX_write_cmos_sensor(0x0F12, 0x01A0);                  //TVAR_wbt_pBaseCcms[52]
S5K5CAGX_write_cmos_sensor(0x0F12, 0x00E8);                  //TVAR_wbt_pBaseCcms[53]
                                                     //CWF
S5K5CAGX_write_cmos_sensor(0x0F12, 0x01DE);                                     //TVAR_wbt_pBaseCcms[54]
S5K5CAGX_write_cmos_sensor(0x0F12, 0xFF9C);                                     //TVAR_wbt_pBaseCcms[55]
S5K5CAGX_write_cmos_sensor(0x0F12, 0xFFDD);                                    //TVAR_wbt_pBaseCcms[56]
S5K5CAGX_write_cmos_sensor(0x0F12, 0xFF1A);                         //TVAR_wbt_pBaseCcms[57]
S5K5CAGX_write_cmos_sensor(0x0F12, 0x0276);                         //TVAR_wbt_pBaseCcms[58]
S5K5CAGX_write_cmos_sensor(0x0F12, 0xFF0D);                         //TVAR_wbt_pBaseCcms[59]
S5K5CAGX_write_cmos_sensor(0x0F12, 0xFF9E);                         //TVAR_wbt_pBaseCcms[60]
S5K5CAGX_write_cmos_sensor(0x0F12, 0xFF9B);                         //TVAR_wbt_pBaseCcms[61]
S5K5CAGX_write_cmos_sensor(0x0F12, 0x0268);                         //TVAR_wbt_pBaseCcms[62]
S5K5CAGX_write_cmos_sensor(0x0F12, 0x011A);                          //TVAR_wbt_pBaseCcms[63]
S5K5CAGX_write_cmos_sensor(0x0F12, 0x0120);                          //TVAR_wbt_pBaseCcms[64]
S5K5CAGX_write_cmos_sensor(0x0F12, 0xFEF5);                          //TVAR_wbt_pBaseCcms[65]
S5K5CAGX_write_cmos_sensor(0x0F12, 0x01C1);                         //TVAR_wbt_pBaseCcms[66]
S5K5CAGX_write_cmos_sensor(0x0F12, 0xFEF5);                         //TVAR_wbt_pBaseCcms[67]
S5K5CAGX_write_cmos_sensor(0x0F12, 0x01CD);                         //TVAR_wbt_pBaseCcms[68]
S5K5CAGX_write_cmos_sensor(0x0F12, 0xFE0E);                         //TVAR_wbt_pBaseCcms[69]
S5K5CAGX_write_cmos_sensor(0x0F12, 0x0222);                         //TVAR_wbt_pBaseCcms[70]
S5K5CAGX_write_cmos_sensor(0x0F12, 0x008D);                         //TVAR_wbt_pBaseCcms[71]
                                                           //D50
S5K5CAGX_write_cmos_sensor(0x0F12, 0x01DE);                    //TVAR_wbt_pBaseCcms[72]  020E D65_6  01FE:D65_13  01E8：D65_20
S5K5CAGX_write_cmos_sensor(0x0F12, 0xFF9C);                    //TVAR_wbt_pBaseCcms[73]
S5K5CAGX_write_cmos_sensor(0x0F12, 0xFFDD);                    //TVAR_wbt_pBaseCcms[74]
S5K5CAGX_write_cmos_sensor(0x0F12, 0xFF1A);                    //TVAR_wbt_pBaseCcms[75]
S5K5CAGX_write_cmos_sensor(0x0F12, 0x0276);                    //TVAR_wbt_pBaseCcms[76]
S5K5CAGX_write_cmos_sensor(0x0F12, 0xFF0D);                    //TVAR_wbt_pBaseCcms[77]
S5K5CAGX_write_cmos_sensor(0x0F12, 0xFF9E);                    //TVAR_wbt_pBaseCcms[78]
S5K5CAGX_write_cmos_sensor(0x0F12, 0xFF9B);                    //TVAR_wbt_pBaseCcms[79]
S5K5CAGX_write_cmos_sensor(0x0F12, 0x0268);                    //TVAR_wbt_pBaseCcms[80]
S5K5CAGX_write_cmos_sensor(0x0F12, 0x011A);                    //TVAR_wbt_pBaseCcms[81]
S5K5CAGX_write_cmos_sensor(0x0F12, 0x0120);                    //TVAR_wbt_pBaseCcms[82]
S5K5CAGX_write_cmos_sensor(0x0F12, 0xFEF5);                    //TVAR_wbt_pBaseCcms[83]
S5K5CAGX_write_cmos_sensor(0x0F12, 0x01C1);                    //TVAR_wbt_pBaseCcms[84]
S5K5CAGX_write_cmos_sensor(0x0F12, 0xFEF5);                    //TVAR_wbt_pBaseCcms[85]
S5K5CAGX_write_cmos_sensor(0x0F12, 0x01CD);                    //TVAR_wbt_pBaseCcms[86]
S5K5CAGX_write_cmos_sensor(0x0F12, 0xFE0E);                    //TVAR_wbt_pBaseCcms[87]
S5K5CAGX_write_cmos_sensor(0x0F12, 0x0222);                    //TVAR_wbt_pBaseCcms[88]
S5K5CAGX_write_cmos_sensor(0x0F12, 0x008D);                    //TVAR_wbt_pBaseCcms[89]
                                                           //D65
S5K5CAGX_write_cmos_sensor(0x0F12, 0x01DE);                //TVAR_wbt_pBaseCcms[90]
S5K5CAGX_write_cmos_sensor(0x0F12, 0xFF9C);                //TVAR_wbt_pBaseCcms[91]
S5K5CAGX_write_cmos_sensor(0x0F12, 0xFFDD);                //TVAR_wbt_pBaseCcms[92]
S5K5CAGX_write_cmos_sensor(0x0F12, 0xFF1A);                //TVAR_wbt_pBaseCcms[93]
S5K5CAGX_write_cmos_sensor(0x0F12, 0x0276);                //TVAR_wbt_pBaseCcms[94]
S5K5CAGX_write_cmos_sensor(0x0F12, 0xFF0D);                //TVAR_wbt_pBaseCcms[95]
S5K5CAGX_write_cmos_sensor(0x0F12, 0xFF9E);                //TVAR_wbt_pBaseCcms[96]
S5K5CAGX_write_cmos_sensor(0x0F12, 0xFF9B);                //TVAR_wbt_pBaseCcms[97]
S5K5CAGX_write_cmos_sensor(0x0F12, 0x0268);                //TVAR_wbt_pBaseCcms[98]
S5K5CAGX_write_cmos_sensor(0x0F12, 0x011A);                //TVAR_wbt_pBaseCcms[99]
S5K5CAGX_write_cmos_sensor(0x0F12, 0x0120);                //TVAR_wbt_pBaseCcms[100]
S5K5CAGX_write_cmos_sensor(0x0F12, 0xFEF5);                //TVAR_wbt_pBaseCcms[101]
S5K5CAGX_write_cmos_sensor(0x0F12, 0x01C1);                //TVAR_wbt_pBaseCcms[102]
S5K5CAGX_write_cmos_sensor(0x0F12, 0xFEF5);                //TVAR_wbt_pBaseCcms[103]
S5K5CAGX_write_cmos_sensor(0x0F12, 0x01CD);                //TVAR_wbt_pBaseCcms[104]
S5K5CAGX_write_cmos_sensor(0x0F12, 0xFE0E);                //TVAR_wbt_pBaseCcms[105]
S5K5CAGX_write_cmos_sensor(0x0F12, 0x0222);                //TVAR_wbt_pBaseCcms[106]
S5K5CAGX_write_cmos_sensor(0x0F12, 0x008D);                //TVAR_wbt_pBaseCcms[107]
                                                              //param_endTVAR_wbt_pBaseCcms
                                                              //param_startTVAR_wbt_pOutdoorCcm
S5K5CAGX_write_cmos_sensor(0x002A, 0x3380);
S5K5CAGX_write_cmos_sensor(0x0F12, 0x018A);            //TVAR_wbt_pOutdoorCcm[0]
S5K5CAGX_write_cmos_sensor(0x0F12, 0xFFC9);            //TVAR_wbt_pOutdoorCcm[1]
S5K5CAGX_write_cmos_sensor(0x0F12, 0x0005);            //TVAR_wbt_pOutdoorCcm[2]
S5K5CAGX_write_cmos_sensor(0x0F12, 0xFF26);            //TVAR_wbt_pOutdoorCcm[3]
S5K5CAGX_write_cmos_sensor(0x0F12, 0x028E);            //TVAR_wbt_pOutdoorCcm[4]
S5K5CAGX_write_cmos_sensor(0x0F12, 0xFF80);            //TVAR_wbt_pOutdoorCcm[5]
S5K5CAGX_write_cmos_sensor(0x0F12, 0x003D);            //TVAR_wbt_pOutdoorCcm[6]
S5K5CAGX_write_cmos_sensor(0x0F12, 0xFFDF);            //TVAR_wbt_pOutdoorCcm[7]
S5K5CAGX_write_cmos_sensor(0x0F12, 0x01DC);            //TVAR_wbt_pOutdoorCcm[8]
S5K5CAGX_write_cmos_sensor(0x0F12, 0x00FF);            //TVAR_wbt_pOutdoorCcm[9]
S5K5CAGX_write_cmos_sensor(0x0F12, 0x00E2);            //TVAR_wbt_pOutdoorCcm[10]
S5K5CAGX_write_cmos_sensor(0x0F12, 0xFF4D);            //TVAR_wbt_pOutdoorCcm[11]
S5K5CAGX_write_cmos_sensor(0x0F12, 0x0179);            //TVAR_wbt_pOutdoorCcm[12]
S5K5CAGX_write_cmos_sensor(0x0F12, 0xFF8A);            //TVAR_wbt_pOutdoorCcm[13]
S5K5CAGX_write_cmos_sensor(0x0F12, 0x0180);            //TVAR_wbt_pOutdoorCcm[14]
S5K5CAGX_write_cmos_sensor(0x0F12, 0xFEC2);            //TVAR_wbt_pOutdoorCcm[15]
S5K5CAGX_write_cmos_sensor(0x0F12, 0x0176);            //TVAR_wbt_pOutdoorCcm[16]
S5K5CAGX_write_cmos_sensor(0x0F12, 0x0094);            //TVAR_wbt_pOutdoorCcm[17]
                                                //param_endTVAR_wbt_pOutdoorCcm
                                                //============================================================
                                                //AFIT
                                                //============================================================
                                                //param_startafit_uNoiseIndInDoor
                                                //============================================================
S5K5CAGX_write_cmos_sensor(0x002A, 0x0764);
S5K5CAGX_write_cmos_sensor(0x0F12, 0x0041);            //afit_uNoiseIndInDoor[0]
S5K5CAGX_write_cmos_sensor(0x0F12, 0x00A5);            //afit_uNoiseIndInDoor[1]
S5K5CAGX_write_cmos_sensor(0x0F12, 0x016B);            //afit_uNoiseIndInDoor[2]
S5K5CAGX_write_cmos_sensor(0x0F12, 0x0226);            //afit_uNoiseIndInDoor[3]
S5K5CAGX_write_cmos_sensor(0x0F12, 0x02EA);            //afit_uNoiseIndInDoor[4]
                                                  //param_endafit_uNoiseIndInDoor
                                                  //param_startTVAR_afit_pBaseVals
...
S5K5CAGX_write_cmos_sensor(0x0F12, 0x0000);                  //TVAR_afit_pBaseVals[2]
S5K5CAGX_write_cmos_sensor(0x0F12, 0x0000);                  //TVAR_afit_pBaseVals[3]
S5K5CAGX_write_cmos_sensor(0x0F12, 0x0000);                  //TVAR_afit_pBaseVals[4]
S5K5CAGX_write_cmos_sensor(0x0F12, 0x001E);                  //TVAR_afit_pBaseVals[5]
...
S5K5CAGX_write_cmos_sensor(0x0F12, 0x0104);                  //TVAR_afit_pBaseVals[12]
S5K5CAGX_write_cmos_sensor(0x0F12, 0x03E8);                  //TVAR_afit_pBaseVals[13]
S5K5CAGX_write_cmos_sensor(0x0F12, 0x0023);                  //TVAR_afit_pBaseVals[14]
S5K5CAGX_write_cmos_sensor(0x0F12, 0x012C);                  //TVAR_afit_pBaseVals[15]
S5K5CAGX_write_cmos_sensor(0x0F12, 0x0070);                  //TVAR_afit_pBaseVals[16]
S5K5CAGX_write_cmos_sensor(0x0F12, 0x0004);                  //TVAR_afit_pBaseVals[17]
S5K5CAGX_write_cmos_sensor(0x0F12, 0x0004);                  //TVAR_afit_pBaseVals[18]
...
S5K5CAGX_write_cmos_sensor(0x0F12, 0x002A);                  //TVAR_afit_pBaseVals[24]
S5K5CAGX_write_cmos_sensor(0x0F12, 0x0024);                  //TVAR_afit_pBaseVals[25]
...
S5K5CAGX_write_cmos_sensor(0x0F12, 0x0A0F);                  //TVAR_afit_pBaseVals[30]
...
S5K5CAGX_write_cmos_sensor(0x0F12, 0x053B);                  //TVAR_afit_pBaseVals[38]
S5K5CAGX_write_cmos_sensor(0x0F12, 0x0505);                  //TVAR_afit_pBaseVals[39]
S5K5CAGX_write_cmos_sensor(0x0F12, 0x0301);                  //TVAR_afit_pBaseVals[40]
S5K5CAGX_write_cmos_sensor(0x0F12, 0x8007);                  //TVAR_afit_pBaseVals[41]
...
S5K5CAGX_write_cmos_sensor(0x0F12, 0x0A06);                  //TVAR_afit_pBaseVals[45]
S5K5CAGX_write_cmos_sensor(0x0F12, 0x103C);                  //TVAR_afit_pBaseVals[46]
...
S5K5CAGX_write_cmos_sensor(0x0F12, 0x1002);                  //TVAR_afit_pBaseVals[50]
S5K5CAGX_write_cmos_sensor(0x0F12, 0x001D);                  //TVAR_afit_pBaseVals[51]
...
S5K5CAGX_write_cmos_sensor(0x0F12, 0x5A03);                  //TVAR_afit_pBaseVals[56]
S5K5CAGX_write_cmos_sensor(0x0F12, 0x006E);                  //TVAR_afit_pBaseVals[57]
S5K5CAGX_write_cmos_sensor(0x0F12, 0x0A78);                  //TVAR_afit_pBaseVals[58]
S5K5CAGX_write_cmos_sensor(0x0F12, 0x0080);                  //TVAR_afit_pBaseVals[59]
S5K5CAGX_write_cmos_sensor(0x0F12, 0x3232);                  //TVAR_afit_pBaseVals[60]
S5K5CAGX_write_cmos_sensor(0x0F12, 0x0101);                  //TVAR_afit_pBaseVals[61]
S5K5CAGX_write_cmos_sensor(0x0F12, 0x5001);                  //TVAR_afit_pBaseVals[62]
...
S5K5CAGX_write_cmos_sensor(0x0F12, 0x1E07);                  //TVAR_afit_pBaseVals[67]
...
S5K5CAGX_write_cmos_sensor(0x0F12, 0x5004);                  //TVAR_afit_pBaseVals[70]
S5K5CAGX_write_cmos_sensor(0x0F12, 0x0F40);                  //TVAR_afit_pBaseVals[71]
S5K5CAGX_write_cmos_sensor(0x0F12, 0x400F);                  //TVAR_afit_pBaseVals[72]
S5K5CAGX_write_cmos_sensor(0x0F12, 0x0204);                  //TVAR_afit_pBaseVals[73]
S5K5CAGX_write_cmos_sensor(0x0F12, 0x3203);                  //TVAR_afit_pBaseVals[74]
S5K5CAGX_write_cmos_sensor(0x0F12, 0x0132);                  //TVAR_afit_pBaseVals[75]
S5K5CAGX_write_cmos_sensor(0x0F12, 0x0101);                  //TVAR_afit_pBaseVals[76]
S5K5CAGX_write_cmos_sensor(0x0F12, 0x5050);                  //TVAR_afit_pBaseVals[77]
S5K5CAGX_write_cmos_sensor(0x0F12, 0x7878);                  //TVAR_afit_pBaseVals[78]
...
S5K5CAGX_write_cmos_sensor(0x0F12, 0x283C);                  //TVAR_afit_pBaseVals[85]
...
S5K5CAGX_write_cmos_sensor(0x0F12, 0x3232);                  //TVAR_afit_pBaseVals[89]
S5K5CAGX_write_cmos_sensor(0x0F12, 0x0101);                  //TVAR_afit_pBaseVals[90]
S5K5CAGX_write_cmos_sensor(0x0F12, 0x5001);                  //TVAR_afit_pBaseVals[91]
S5K5CAGX_write_cmos_sensor(0x0F12, 0x7850);                  //TVAR_afit_pBaseVals[92]
S5K5CAGX_write_cmos_sensor(0x0F12, 0x2878);                  //TVAR_afit_pBaseVals[93]
...
S5K5CAGX_write_cmos_sensor(0x0F12, 0x0000);                  //TVAR_afit_pBaseVals[106]
S5K5CAGX_write_cmos_sensor(0x0F12, 0x0000);                  //TVAR_afit_pBaseVals[107]
S5K5CAGX_write_cmos_sensor(0x0F12, 0x0000);                  //TVAR_afit_pBaseVals[108]
S5K5CAGX_write_cmos_sensor(0x0F12, 0x001E);                  //TVAR_afit_pBaseVals[109]
...
S5K5CAGX_write_cmos_sensor(0x0F12, 0x0104);                  //TVAR_afit_pBaseVals[116]
S5K5CAGX_write_cmos_sensor(0x0F12, 0x03E8);                  //TVAR_afit_pBaseVals[117]
S5K5CAGX_write_cmos_sensor(0x0F12, 0x0023);                  //TVAR_afit_pBaseVals[118]
S5K5CAGX_write_cmos_sensor(0x0F12, 0x012C);                  //TVAR_afit_pBaseVals[119]
S5K5CAGX_write_cmos_sensor(0x0F12, 0x0070);                  //TVAR_afit_pBaseVals[120]
S5K5CAGX_write_cmos_sensor(0x0F12, 0x0004);                  //TVAR_afit_pBaseVals[121]
S5K5CAGX_write_cmos_sensor(0x0F12, 0x0004);                  //TVAR_afit_pBaseVals[122]
S5K5CAGX_write_cmos_sensor(0x0F12, 0x01AA);                  //TVAR_afit_pBaseVals[123]
S5K5CAGX_write_cmos_sensor(0x0F12, 0x001E);                  //TVAR_afit_pBaseVals[124]
S5K5CAGX_write_cmos_sensor(0x0F12, 0x001E);                  //TVAR_afit_pBaseVals[125]
...
S5K5CAGX_write_cmos_sensor(0x0F12, 0x002A);                  //TVAR_afit_pBaseVals[128]
S5K5CAGX_write_cmos_sensor(0x0F12, 0x0024);                  //TVAR_afit_pBaseVals[129]
...
S5K5CAGX_write_cmos_sensor(0x0F12, 0x0A0F);                  //TVAR_afit_pBaseVals[134]
...
S5K5CAGX_write_cmos_sensor(0x0F12, 0x0101);                  //TVAR_afit_pBaseVals[140]
S5K5CAGX_write_cmos_sensor(0x0F12, 0x00FF);                  //TVAR_afit_pBaseVals[141]
S5K5CAGX_write_cmos_sensor(0x0F12, 0x053B);                  //TVAR_afit_pBaseVals[142]
S5K5CAGX_write_cmos_sensor(0x0F12, 0x0505);                  //TVAR_afit_pBaseVals[143]
S5K5CAGX_write_cmos_sensor(0x0F12, 0x0301);                  //TVAR_afit_pBaseVals[144]
S5K5CAGX_write_cmos_sensor(0x0F12, 0x8007);                  //TVAR_afit_pBaseVals[145]
...
S5K5CAGX_write_cmos_sensor(0x0F12, 0x0A06);                  //TVAR_afit_pBaseVals[149]
S5K5CAGX_write_cmos_sensor(0x0F12, 0x103C);                  //TVAR_afit_pBaseVals[150]
...
S5K5CAGX_write_cmos_sensor(0x0F12, 0x1002);                  //TVAR_afit_pBaseVals[154]
S5K5CAGX_write_cmos_sensor(0x0F12, 0x001D);                  //TVAR_afit_pBaseVals[155]
...
S5K5CAGX_write_cmos_sensor(0x0F12, 0x5F03);                  //TVAR_afit_pBaseVals[160]
S5K5CAGX_write_cmos_sensor(0x0F12, 0x0080);                  //TVAR_afit_pBaseVals[161]
S5K5CAGX_write_cmos_sensor(0x0F12, 0x0080);                  //TVAR_afit_pBaseVals[162]
S5K5CAGX_write_cmos_sensor(0x0F12, 0x0080);                  //TVAR_afit_pBaseVals[163]
S5K5CAGX_write_cmos_sensor(0x0F12, 0x3232);                  //TVAR_afit_pBaseVals[164]
S5K5CAGX_write_cmos_sensor(0x0F12, 0x0101);                  //TVAR_afit_pBaseVals[165]
S5K5CAGX_write_cmos_sensor(0x0F12, 0x2A01);                  //TVAR_afit_pBaseVals[166]
S5K5CAGX_write_cmos_sensor(0x0F12, 0x3232);                  //TVAR_afit_pBaseVals[167]
S5K5CAGX_write_cmos_sensor(0x0F12, 0x2830);                  //TVAR_afit_pBaseVals[168]
...
S5K5CAGX_write_cmos_sensor(0x0F12, 0x1E07);                  //TVAR_afit_pBaseVals[171]
...
S5K5CAGX_write_cmos_sensor(0x0F12, 0x5004);                  //TVAR_afit_pBaseVals[174]
S5K5CAGX_write_cmos_sensor(0x0F12, 0x0F40);                  //TVAR_afit_pBaseVals[175]
S5K5CAGX_write_cmos_sensor(0x0F12, 0x400F);                  //TVAR_afit_pBaseVals[176]
S5K5CAGX_write_cmos_sensor(0x0F12, 0x0204);                  //TVAR_afit_pBaseVals[177]
S5K5CAGX_write_cmos_sensor(0x0F12, 0x3203);                  //TVAR_afit_pBaseVals[178]
S5K5CAGX_write_cmos_sensor(0x0F12, 0x0132);                  //TVAR_afit_pBaseVals[179]
S5K5CAGX_write_cmos_sensor(0x0F12, 0x0101);                  //TVAR_afit_pBaseVals[180]
S5K5CAGX_write_cmos_sensor(0x0F12, 0x262A);                  //TVAR_afit_pBaseVals[181]
S5K5CAGX_write_cmos_sensor(0x0F12, 0x3032);                  //TVAR_afit_pBaseVals[182]
...
S5K5CAGX_write_cmos_sensor(0x0F12, 0x283C);                  //TVAR_afit_pBaseVals[189]
...
S5K5CAGX_write_cmos_sensor(0x0F12, 0x3232);                  //TVAR_afit_pBaseVals[193]
S5K5CAGX_write_cmos_sensor(0x0F12, 0x0101);                  //TVAR_afit_pBaseVals[194]
S5K5CAGX_write_cmos_sensor(0x0F12, 0x2A01);                  //TVAR_afit_pBaseVals[195]
S5K5CAGX_write_cmos_sensor(0x0F12, 0x3226);                  //TVAR_afit_pBaseVals[196]
S5K5CAGX_write_cmos_sensor(0x0F12, 0x2830);                  //TVAR_afit_pBaseVals[197]
...
S5K5CAGX_write_cmos_sensor(0x0F12, 0x0000);                  //TVAR_afit_pBaseVals[210]
S5K5CAGX_write_cmos_sensor(0x0F12, 0x0000);                  //TVAR_afit_pBaseVals[211]
S5K5CAGX_write_cmos_sensor(0x0F12, 0x0000);                  //TVAR_afit_pBaseVals[212]
S5K5CAGX_write_cmos_sensor(0x0F12, 0x001E);                  //TVAR_afit_pBaseVals[213]
...
S5K5CAGX_write_cmos_sensor(0x0F12, 0x0041);                  //TVAR_afit_pBaseVals[222]
S5K5CAGX_write_cmos_sensor(0x0F12, 0x005A);                  //TVAR_afit_pBaseVals[223]
...
S5K5CAGX_write_cmos_sensor(0x0F12, 0x000A);                  //TVAR_afit_pBaseVals[230]
S5K5CAGX_write_cmos_sensor(0x0F12, 0x000A);                  //TVAR_afit_pBaseVals[231]
S5K5CAGX_write_cmos_sensor(0x0F12, 0x0032);                  //TVAR_afit_pBaseVals[232]
S5K5CAGX_write_cmos_sensor(0x0F12, 0x0028);                  //TVAR_afit_pBaseVals[233]
S5K5CAGX_write_cmos_sensor(0x0F12, 0x0032);                  //TVAR_afit_pBaseVals[234]
S5K5CAGX_write_cmos_sensor(0x0F12, 0x0028);                  //TVAR_afit_pBaseVals[235]
S5K5CAGX_write_cmos_sensor(0x0F12, 0x0032);                  //TVAR_afit_pBaseVals[236]
S5K5CAGX_write_cmos_sensor(0x0F12, 0x0028);                  //TVAR_afit_pBaseVals[237]
S5K5CAGX_write_cmos_sensor(0x0F12, 0x0A0F);                  //TVAR_afit_pBaseVals[238]
...
S5K5CAGX_write_cmos_sensor(0x0F12, 0x0404);                  //TVAR_afit_pBaseVals[244]
...
S5K5CAGX_write_cmos_sensor(0x0F12, 0x0505);                  //TVAR_afit_pBaseVals[247]
S5K5CAGX_write_cmos_sensor(0x0F12, 0x0301);                  //TVAR_afit_pBaseVals[248]
S5K5CAGX_write_cmos_sensor(0x0F12, 0x8007);                  //TVAR_afit_pBaseVals[249]
...
S5K5CAGX_write_cmos_sensor(0x0F12, 0x0A06);                  //TVAR_afit_pBaseVals[253]
S5K5CAGX_write_cmos_sensor(0x0F12, 0x0A4B);                  //TVAR_afit_pBaseVals[254]
S5K5CAGX_write_cmos_sensor(0x0F12, 0x0537);                  //TVAR_afit_pBaseVals[255]
...
S5K5CAGX_write_cmos_sensor(0x0F12, 0x1002);                  //TVAR_afit_pBaseVals[258]
S5K5CAGX_write_cmos_sensor(0x0F12, 0x001D);                  //TVAR_afit_pBaseVals[259]
...
S5K5CAGX_write_cmos_sensor(0x0F12, 0x6902);                  //TVAR_afit_pBaseVals[264]
S5K5CAGX_write_cmos_sensor(0x0F12, 0x0080);                  //TVAR_afit_pBaseVals[265]
S5K5CAGX_write_cmos_sensor(0x0F12, 0x0080);                  //TVAR_afit_pBaseVals[266]
S5K5CAGX_write_cmos_sensor(0x0F12, 0x0080);                  //TVAR_afit_pBaseVals[267]
S5K5CAGX_write_cmos_sensor(0x0F12, 0x2D2D);                  //TVAR_afit_pBaseVals[268]
S5K5CAGX_write_cmos_sensor(0x0F12, 0x0101);                  //TVAR_afit_pBaseVals[269]
S5K5CAGX_write_cmos_sensor(0x0F12, 0x2001);                  //TVAR_afit_pBaseVals[270]
S5K5CAGX_write_cmos_sensor(0x0F12, 0x2026);                  //TVAR_afit_pBaseVals[271]
S5K5CAGX_write_cmos_sensor(0x0F12, 0x281E);                  //TVAR_afit_pBaseVals[272]
S5K5CAGX_write_cmos_sensor(0x0F12, 0x0A00);                  //TVAR_afit_pBaseVals[273]
S5K5CAGX_write_cmos_sensor(0x0F12, 0x0A03);                  //TVAR_afit_pBaseVals[274]
S5K5CAGX_write_cmos_sensor(0x0F12, 0x1E0A);                  //TVAR_afit_pBaseVals[275]
...
S5K5CAGX_write_cmos_sensor(0x0F12, 0x5F04);                  //TVAR_afit_pBaseVals[278]
S5K5CAGX_write_cmos_sensor(0x0F12, 0x0F55);                  //TVAR_afit_pBaseVals[279]
...
S5K5CAGX_write_cmos_sensor(0x0F12, 0x3203);                  //TVAR_afit_pBaseVals[282]
S5K5CAGX_write_cmos_sensor(0x0F12, 0x0132);                  //TVAR_afit_pBaseVals[283]
S5K5CAGX_write_cmos_sensor(0x0F12, 0x0101);                  //TVAR_afit_pBaseVals[284]
S5K5CAGX_write_cmos_sensor(0x0F12, 0x1C20);                  //TVAR_afit_pBaseVals[285]
S5K5CAGX_write_cmos_sensor(0x0F12, 0x1C1E);                  //TVAR_afit_pBaseVals[286]
...
S5K5CAGX_write_cmos_sensor(0x0F12, 0x0A0A);                  //TVAR_afit_pBaseVals[289]
...
S5K5CAGX_write_cmos_sensor(0x0F12, 0x283C);                  //TVAR_afit_pBaseVals[293]
...
S5K5CAGX_write_cmos_sensor(0x0F12, 0x3232);                  //TVAR_afit_pBaseVals[297]
S5K5CAGX_write_cmos_sensor(0x0F12, 0x0101);                  //TVAR_afit_pBaseVals[298]
S5K5CAGX_write_cmos_sensor(0x0F12, 0x2001);                  //TVAR_afit_pBaseVals[299]
S5K5CAGX_write_cmos_sensor(0x0F12, 0x1E1C);                  //TVAR_afit_pBaseVals[300]
S5K5CAGX_write_cmos_sensor(0x0F12, 0x281C);                  //TVAR_afit_pBaseVals[301]
S5K5CAGX_write_cmos_sensor(0x0F12, 0x0A00);                  //TVAR_afit_pBaseVals[302]
S5K5CAGX_write_cmos_sensor(0x0F12, 0x0A03);                  //TVAR_afit_pBaseVals[303]
S5K5CAGX_write_cmos_sensor(0x0F12, 0x1E0A);                  //TVAR_afit_pBaseVals[304]
...
S5K5CAGX_write_cmos_sensor(0x0F12, 0x0000);                  //TVAR_afit_pBaseVals[314]
...
S5K5CAGX_write_cmos_sensor(0x0F12, 0x001E);                  //TVAR_afit_pBaseVals[317]
...
S5K5CAGX_write_cmos_sensor(0x0F12, 0x012C);                  //TVAR_afit_pBaseVals[324]
S5K5CAGX_write_cmos_sensor(0x0F12, 0x03E8);                  //TVAR_afit_pBaseVals[325]
S5K5CAGX_write_cmos_sensor(0x0F12, 0x0050);                  //TVAR_afit_pBaseVals[326]
S5K5CAGX_write_cmos_sensor(0x0F12, 0x00C8);                  //TVAR_afit_pBaseVals[327]
S5K5CAGX_write_cmos_sensor(0x0F12, 0x0070);                  //TVAR_afit_pBaseVals[328]
S5K5CAGX_write_cmos_sensor(0x0F12, 0x0004);                  //TVAR_afit_pBaseVals[329]
S5K5CAGX_write_cmos_sensor(0x0F12, 0x0004);                  //TVAR_afit_pBaseVals[330]
S5K5CAGX_write_cmos_sensor(0x0F12, 0x01AA);                  //TVAR_afit_pBaseVals[331]
S5K5CAGX_write_cmos_sensor(0x0F12, 0x0014);                  //TVAR_afit_pBaseVals[332]
S5K5CAGX_write_cmos_sensor(0x0F12, 0x0014);                  //TVAR_afit_pBaseVals[333]
...
S5K5CAGX_write_cmos_sensor(0x0F12, 0x0032);                  //TVAR_afit_pBaseVals[336]
S5K5CAGX_write_cmos_sensor(0x0F12, 0x0023);                  //TVAR_afit_pBaseVals[337]
...
S5K5CAGX_write_cmos_sensor(0x0F12, 0x0A0F);                  //TVAR_afit_pBaseVals[342]
...
S5K5CAGX_write_cmos_sensor(0x0F12, 0x0404);                  //TVAR_afit_pBaseVals[348]
S5K5CAGX_write_cmos_sensor(0x0F12, 0x00FF);                  //TVAR_afit_pBaseVals[349]
S5K5CAGX_write_cmos_sensor(0x0F12, 0x033B);                  //TVAR_afit_pBaseVals[350]
S5K5CAGX_write_cmos_sensor(0x0F12, 0x0505);                  //TVAR_afit_pBaseVals[351]
S5K5CAGX_write_cmos_sensor(0x0F12, 0x0301);                  //TVAR_afit_pBaseVals[352]
S5K5CAGX_write_cmos_sensor(0x0F12, 0x8007);                  //TVAR_afit_pBaseVals[353]
...
S5K5CAGX_write_cmos_sensor(0x0F12, 0x0A06);                  //TVAR_afit_pBaseVals[357]
S5K5CAGX_write_cmos_sensor(0x0F12, 0x0A4B);                  //TVAR_afit_pBaseVals[358]
S5K5CAGX_write_cmos_sensor(0x0F12, 0x0837);                  //TVAR_afit_pBaseVals[359]
...
S5K5CAGX_write_cmos_sensor(0x0F12, 0x001D);                  //TVAR_afit_pBaseVals[363]
...
S5K5CAGX_write_cmos_sensor(0x0F12, 0x6F02);                  //TVAR_afit_pBaseVals[368]
S5K5CAGX_write_cmos_sensor(0x0F12, 0x0080);                  //TVAR_afit_pBaseVals[369]
S5K5CAGX_write_cmos_sensor(0x0F12, 0x0080);                  //TVAR_afit_pBaseVals[370]
S5K5CAGX_write_cmos_sensor(0x0F12, 0x0080);                  //TVAR_afit_pBaseVals[371]
S5K5CAGX_write_cmos_sensor(0x0F12, 0x323C);                  //TVAR_afit_pBaseVals[372]
S5K5CAGX_write_cmos_sensor(0x0F12, 0x0101);                  //TVAR_afit_pBaseVals[373]
S5K5CAGX_write_cmos_sensor(0x0F12, 0x1A01);                  //TVAR_afit_pBaseVals[374]
S5K5CAGX_write_cmos_sensor(0x0F12, 0x1A1E);                  //TVAR_afit_pBaseVals[375]
S5K5CAGX_write_cmos_sensor(0x0F12, 0x2818);                  //TVAR_afit_pBaseVals[376]
S5K5CAGX_write_cmos_sensor(0x0F12, 0x0A00);                  //TVAR_afit_pBaseVals[377]
S5K5CAGX_write_cmos_sensor(0x0F12, 0x1403);                  //TVAR_afit_pBaseVals[378]
S5K5CAGX_write_cmos_sensor(0x0F12, 0x1905);                  //TVAR_afit_pBaseVals[379]
S5K5CAGX_write_cmos_sensor(0x0F12, 0x060E);                  //TVAR_afit_pBaseVals[380]
S5K5CAGX_write_cmos_sensor(0x0F12, 0x32FF);                  //TVAR_afit_pBaseVals[381]
S5K5CAGX_write_cmos_sensor(0x0F12, 0x5F04);                  //TVAR_afit_pBaseVals[382]
S5K5CAGX_write_cmos_sensor(0x0F12, 0x1455);                  //TVAR_afit_pBaseVals[383]
S5K5CAGX_write_cmos_sensor(0x0F12, 0x4015);                  //TVAR_afit_pBaseVals[384]
S5K5CAGX_write_cmos_sensor(0x0F12, 0x0204);                  //TVAR_afit_pBaseVals[385]
S5K5CAGX_write_cmos_sensor(0x0F12, 0x3C03);                  //TVAR_afit_pBaseVals[386]
S5K5CAGX_write_cmos_sensor(0x0F12, 0x013C);                  //TVAR_afit_pBaseVals[387]
S5K5CAGX_write_cmos_sensor(0x0F12, 0x0101);                  //TVAR_afit_pBaseVals[388]
S5K5CAGX_write_cmos_sensor(0x0F12, 0x141A);                  //TVAR_afit_pBaseVals[389]
S5K5CAGX_write_cmos_sensor(0x0F12, 0x181A);                  //TVAR_afit_pBaseVals[390]
...
S5K5CAGX_write_cmos_sensor(0x0F12, 0x0614);                  //TVAR_afit_pBaseVals[393]
S5K5CAGX_write_cmos_sensor(0x0F12, 0x0A19);                  //TVAR_afit_pBaseVals[394]
S5K5CAGX_write_cmos_sensor(0x0F12, 0xFF06);                  //TVAR_afit_pBaseVals[395]
S5K5CAGX_write_cmos_sensor(0x0F12, 0x0432);                  //TVAR_afit_pBaseVals[396]
S5K5CAGX_write_cmos_sensor(0x0F12, 0x283C);                  //TVAR_afit_pBaseVals[397]
S5K5CAGX_write_cmos_sensor(0x0F12, 0x1514);                  //TVAR_afit_pBaseVals[398]
...
S5K5CAGX_write_cmos_sensor(0x0F12, 0x3C3C);                  //TVAR_afit_pBaseVals[401]
S5K5CAGX_write_cmos_sensor(0x0F12, 0x0101);                  //TVAR_afit_pBaseVals[402]
S5K5CAGX_write_cmos_sensor(0x0F12, 0x1A01);                  //TVAR_afit_pBaseVals[403]
S5K5CAGX_write_cmos_sensor(0x0F12, 0x1A14);                  //TVAR_afit_pBaseVals[404]
S5K5CAGX_write_cmos_sensor(0x0F12, 0x2818);                  //TVAR_afit_pBaseVals[405]
S5K5CAGX_write_cmos_sensor(0x0F12, 0x0A00);                  //TVAR_afit_pBaseVals[406]
S5K5CAGX_write_cmos_sensor(0x0F12, 0x1403);                  //TVAR_afit_pBaseVals[407]
S5K5CAGX_write_cmos_sensor(0x0F12, 0x1906);                  //TVAR_afit_pBaseVals[408]
S5K5CAGX_write_cmos_sensor(0x0F12, 0x060A);                  //TVAR_afit_pBaseVals[409]
...
S5K5CAGX_write_cmos_sensor(0x0F12, 0x1440);                  //TVAR_afit_pBaseVals[412]
S5K5CAGX_write_cmos_sensor(0x0F12, 0x4015);                  //TVAR_afit_pBaseVals[413]
...
S5K5CAGX_write_cmos_sensor(0x0F12, 0x0000);                  //TVAR_afit_pBaseVals[418]
...
S5K5CAGX_write_cmos_sensor(0x0F12, 0x001E);                  //TVAR_afit_pBaseVals[421]
...
S5K5CAGX_write_cmos_sensor(0x0F12, 0x0000);                  //TVAR_afit_pBaseVals[428]
S5K5CAGX_write_cmos_sensor(0x0F12, 0x0000);                  //TVAR_afit_pBaseVals[429]
S5K5CAGX_write_cmos_sensor(0x0F12, 0x0046);                  //TVAR_afit_pBaseVals[430]
S5K5CAGX_write_cmos_sensor(0x0F12, 0x0050);                  //TVAR_afit_pBaseVals[431]
S5K5CAGX_write_cmos_sensor(0x0F12, 0x0070);                  //TVAR_afit_pBaseVals[432]
S5K5CAGX_write_cmos_sensor(0x0F12, 0x0004);                  //TVAR_afit_pBaseVals[433]
S5K5CAGX_write_cmos_sensor(0x0F12, 0x0004);                  //TVAR_afit_pBaseVals[434]
...
S5K5CAGX_write_cmos_sensor(0x0F12, 0x002D);                  //TVAR_afit_pBaseVals[440]
S5K5CAGX_write_cmos_sensor(0x0F12, 0x0019);                  //TVAR_afit_pBaseVals[441]
S5K5CAGX_write_cmos_sensor(0x0F12, 0x0023);                  //TVAR_afit_pBaseVals[442]
...
S5K5CAGX_write_cmos_sensor(0x0F12, 0x0023);                  //TVAR_afit_pBaseVals[445]
S5K5CAGX_write_cmos_sensor(0x0F12, 0x0A0F);                  //TVAR_afit_pBaseVals[446]
...
S5K5CAGX_write_cmos_sensor(0x0F12, 0x0606);                  //TVAR_afit_pBaseVals[452]
S5K5CAGX_write_cmos_sensor(0x0F12, 0x00FF);                  //TVAR_afit_pBaseVals[453]
S5K5CAGX_write_cmos_sensor(0x0F12, 0x033B);                  //TVAR_afit_pBaseVals[454]
S5K5CAGX_write_cmos_sensor(0x0F12, 0x0505);                  //TVAR_afit_pBaseVals[455]
S5K5CAGX_write_cmos_sensor(0x0F12, 0x0301);                  //TVAR_afit_pBaseVals[456]
S5K5CAGX_write_cmos_sensor(0x0F12, 0x8007);                  //TVAR_afit_pBaseVals[457]
...
S5K5CAGX_write_cmos_sensor(0x0F12, 0x0A06);                  //TVAR_afit_pBaseVals[461]
S5K5CAGX_write_cmos_sensor(0x0F12, 0x1E4B);                  //TVAR_afit_pBaseVals[462]
S5K5CAGX_write_cmos_sensor(0x0F12, 0x1037);                  //TVAR_afit_pBaseVals[463]
S5K5CAGX_write_cmos_sensor(0x0F12, 0x0002);                  //TVAR_afit_pBaseVals[464]
S5K5CAGX_write_cmos_sensor(0x0F12, 0x00FF);                  //TVAR_afit_pBaseVals[465]
...
S5K5CAGX_write_cmos_sensor(0x0F12, 0x8002);                  //TVAR_afit_pBaseVals[472]
S5K5CAGX_write_cmos_sensor(0x0F12, 0x0080);                  //TVAR_afit_pBaseVals[473]
S5K5CAGX_write_cmos_sensor(0x0F12, 0x0080);                  //TVAR_afit_pBaseVals[474]
S5K5CAGX_write_cmos_sensor(0x0F12, 0x0080);                  //TVAR_afit_pBaseVals[475]
S5K5CAGX_write_cmos_sensor(0x0F12, 0x4646);                  //TVAR_afit_pBaseVals[476]
S5K5CAGX_write_cmos_sensor(0x0F12, 0x0101);                  //TVAR_afit_pBaseVals[477]
S5K5CAGX_write_cmos_sensor(0x0F12, 0x1801);                  //TVAR_afit_pBaseVals[478]
S5K5CAGX_write_cmos_sensor(0x0F12, 0x141C);                  //TVAR_afit_pBaseVals[479]
S5K5CAGX_write_cmos_sensor(0x0F12, 0x2812);                  //TVAR_afit_pBaseVals[480]
S5K5CAGX_write_cmos_sensor(0x0F12, 0x0A00);                  //TVAR_afit_pBaseVals[481]
S5K5CAGX_write_cmos_sensor(0x0F12, 0x1003);                  //TVAR_afit_pBaseVals[482]
S5K5CAGX_write_cmos_sensor(0x0F12, 0x1405);                  //TVAR_afit_pBaseVals[483]
S5K5CAGX_write_cmos_sensor(0x0F12, 0x050C);                  //TVAR_afit_pBaseVals[484]
S5K5CAGX_write_cmos_sensor(0x0F12, 0x32FF);                  //TVAR_afit_pBaseVals[485]
S5K5CAGX_write_cmos_sensor(0x0F12, 0x5F04);                  //TVAR_afit_pBaseVals[486]
S5K5CAGX_write_cmos_sensor(0x0F12, 0x1455);                  //TVAR_afit_pBaseVals[487]
S5K5CAGX_write_cmos_sensor(0x0F12, 0x4015);                  //TVAR_afit_pBaseVals[488]
S5K5CAGX_write_cmos_sensor(0x0F12, 0x0204);                  //TVAR_afit_pBaseVals[489]
S5K5CAGX_write_cmos_sensor(0x0F12, 0x5003);                  //TVAR_afit_pBaseVals[490]
S5K5CAGX_write_cmos_sensor(0x0F12, 0x0150);                  //TVAR_afit_pBaseVals[491]
S5K5CAGX_write_cmos_sensor(0x0F12, 0x0101);                  //TVAR_afit_pBaseVals[492]
S5K5CAGX_write_cmos_sensor(0x0F12, 0x1418);                  //TVAR_afit_pBaseVals[493]
S5K5CAGX_write_cmos_sensor(0x0F12, 0x1214);                  //TVAR_afit_pBaseVals[494]
...
S5K5CAGX_write_cmos_sensor(0x0F12, 0x283C);                  //TVAR_afit_pBaseVals[501]
...
S5K5CAGX_write_cmos_sensor(0x0F12, 0x1801);                  //TVAR_afit_pBaseVals[507]
S5K5CAGX_write_cmos_sensor(0x0F12, 0x1414);                  //TVAR_afit_pBaseVals[508]
...
S5K5CAGX_write_cmos_sensor(0x0F12, 0x0003);                  //TVAR_afit_pBaseVals[519]
                                                       //param_endTVAR_afit_pBaseVals
                                                       //param_startafit_pConstBaseVals
S5K5CAGX_write_cmos_sensor(0x002A, 0x0BD4);
S5K5CAGX_write_cmos_sensor(0x0F12, 0x7F7A);            //afit_pConstBaseVals[0]
S5K5CAGX_write_cmos_sensor(0x0F12, 0x779D);            //afit_pConstBaseVals[1]
S5K5CAGX_write_cmos_sensor(0x0F12, 0xBE7E);            //afit_pConstBaseVals[2]
...
S5K5CAGX_write_cmos_sensor(0x0028, 0x7000);
S5K5CAGX_write_cmos_sensor(0x002A, 0x0C18);              //#AFC_Default60Hz
S5K5CAGX_write_cmos_sensor(0x0F12, 0x0000);            //0001              // #AFC_Default60Hz  1: Auto Flicker 60Hz start 0: Auto Flicker 50Hz start

S5K5CAGX_write_cmos_sensor(0x002A, 0x04BA);
S5K5CAGX_write_cmos_sensor(0x0F12, 0x0001);
S5K5CAGX_write_cmos_sensor(0x0F12, 0x0001);

S5K5CAGX_write_cmos_sensor(0x002A, 0x04D2);              // #REG_TC_DBG_AutoAlgEnBits
S5K5CAGX_write_cmos_sensor(0x0F12, 0x065F);               //067F

S5K5CAGX_write_cmos_sensor(0x002A, 0x020E);       
S5K5CAGX_write_cmos_sensor(0x0F12, 0x0015);            //Contr

S5K5CAGX_write_cmos_sensor(0x002A, 0x0e36);              // #REG_TC_DBG_AutoAlgEnBits
S5K5CAGX_write_cmos_sensor(0x0F12, 0x0028);               //067F

S5K5CAGX_write_cmos_sensor(0x0F12, 0xffd8);       
S5K5CAGX_write_cmos_sensor(0x0F12, 0x0000);            //Contr
	//================================================================
	// END Tuning part					 
	//================================================================
...
#endif
	S5K5CAGX_write_cmos_sensor(0x0F12, 0x01f4);//S5K5CAGX_CAM_NOM_MAX_FR_TIME); //#REG_0TC_PCFG_usMaxFrTimeMsecMult10 //10fps
	S5K5CAGX_write_cmos_sensor(0x0F12, 0x014d);//S5K5CAGX_CAM_NOM_MIN_FR_TIME); //#REG_0TC_PCFG_usMinFrTimeMsecMult10 //30fps
	...
	switch (para)
	{
		...
		break; 
			...
			case AWB_MODE_CLOUDY_DAYLIGHT:	
				...
				S5K5CAGX_write_cmos_sensor(0x0F12, 0x0777); //#REG_TC_DBG_AutoAlgEnBits,AWBOff
				S5K5CAGX_write_cmos_sensor(0x002A, 0x04A0);
				S5K5CAGX_write_cmos_sensor(0x0F12, 0x0500); //#REG_SF_USER_Rgain
				S5K5CAGX_write_cmos_sensor(0x0F12, 0x0001);
				S5K5CAGX_write_cmos_sensor(0x0F12, 0x0400); //#REG_SF_USER_Ggain
				S5K5CAGX_write_cmos_sensor(0x0F12, 0x0001);
				S5K5CAGX_write_cmos_sensor(0x0F12, 0x0485); //#REG_SF_USER_Bgain
				S5K5CAGX_write_cmos_sensor(0x0F12, 0x0001); 											
				break;

			case AWB_MODE_FLUORESCENT:
				//==================================================================
				//	MWB : Florescent_TL84	CWF											  
				//==================================================================
				S5K5CAGX_write_cmos_sensor(0x0F12, 0x0777); //#REG_TC_DBG_AutoAlgEnBits,AWBOff
				S5K5CAGX_write_cmos_sensor(0x002A, 0x04A0);
				S5K5CAGX_write_cmos_sensor(0x0F12, 0x0585); //#REG_SF_USER_Rgain
				S5K5CAGX_write_cmos_sensor(0x0F12, 0x0001);
				S5K5CAGX_write_cmos_sensor(0x0F12, 0x0400); //#REG_SF_USER_Ggain
				S5K5CAGX_write_cmos_sensor(0x0F12, 0x0001);
				S5K5CAGX_write_cmos_sensor(0x0F12, 0x075c); //#REG_SF_USER_Bgain
				S5K5CAGX_write_cmos_sensor(0x0F12, 0x0001);
				break;

			case AWB_MODE_INCANDESCENT:
				//==============================================									   
				//	MWB : Incand_Tungsten	 A					
				//==============================================
				S5K5CAGX_write_cmos_sensor(0x0F12, 0x0777); //#REG_TC_DBG_AutoAlgEnBits,AWBOff
				S5K5CAGX_write_cmos_sensor(0x002A, 0x04A0);
				S5K5CAGX_write_cmos_sensor(0x0F12, 0x0400); //#REG_SF_USER_Rgain
				S5K5CAGX_write_cmos_sensor(0x0F12, 0x0001);
				S5K5CAGX_write_cmos_sensor(0x0F12, 0x047A); //#REG_SF_USER_Ggain
				S5K5CAGX_write_cmos_sensor(0x0F12, 0x0001);
				S5K5CAGX_write_cmos_sensor(0x0F12, 0x0947); //#REG_SF_USER_Bgain
				S5K5CAGX_write_cmos_sensor(0x0F12, 0x0001);
				break;
...
kal_bool S5K5CAGX_set_param_effect(UINT16 para)
{
	...
	switch (para)
	{
		...
		case MEFFECT_NEGATIVE:
		   S5K5CAGX_write_cmos_sensor(0x0F12, 0x0003); // Negative Mono
		break;
		default:
		   return KAL_FALSE;
	}
...
void S5K5CAGX_night_mode(kal_bool enable)
{
	...
	else
	{
		...
		{
			S5K5CAGX_write_cmos_sensor(0x0F12, 0x01f4); //#REG_0TC_PCFG_usMaxFrTimeMsecMult10  20fps //S5K5CAGX_CAM_NOM_MAX_FR_TIME
			S5K5CAGX_write_cmos_sensor(0x0F12, 0x014d); //#REG_0TC_PCFG_usMinFrTimeMsecMult10   30fps// S5K5CAGX_CAM_NOM_MIN_FR_TIME
			S5K5CAGX_write_cmos_sensor(0x002A, 0x1680);	//Set Shutter Speed
...
void S5K5CAGXGetExifInfo(UINT32 exifAddr)
{
    SENSOR_EXIF_INFO_STRUCT* pExifInfo = (SENSOR_EXIF_INFO_STRUCT*)exifAddr;
    pExifInfo->FNumber = 28;
    pExifInfo->AEISOSpeed = AE_ISO_100;
    pExifInfo->AWBMode = S5K5CAGX_current_awb;
	...
	switch (FeatureId)
	{
		...
		break;
                case SENSOR_FEATURE_GET_EXIF_INFO:
                     ...
                     S5K5CAGXGetExifInfo(*pFeatureData32);
                break;
		default:
		break;			
	}
