...
UINT32 S5K4E1GA_RAW_SensorInit(PSENSOR_FUNCTION_STRUCT *pfFunc);//maliyan
...
#endif
#if defined(S5K4E1GA_RAW)     //maliyan
    {S5K4E1GA_SENSOR_ID, SENSOR_DRVNAME_S5K4E1GA_RAW, S5K4E1GA_RAW_SensorInit}, 
#endif
