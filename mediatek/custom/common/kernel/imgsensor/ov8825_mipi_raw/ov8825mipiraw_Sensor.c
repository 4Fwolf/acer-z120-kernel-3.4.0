...
/*---------------------------------OTP CODE START-------------------------------------------------*/
#if defined(DOOV_WG980)||defined(DOOV_WG968)
#define OTP_SUPPORT
#endif
...
#if defined(DOOV_WG980)||defined(DOOV_WG968)
 	OV8825_write_cmos_sensor(0x361c, 0x07);  //  Note ： 增加VCM 的推动电流为 100ma  //20120821
#endif
                                                ...
                                                MSDK_SENSOR_CONFIG_STRUCT *sensor_config_data)
{
	...
	spin_lock(&ov8825mipiraw_drv_lock);
	ov8825.imgMirror = IMAGE_HV_MIRROR;//sensor_config_data->SensorImageMirror;
	spin_unlock(&ov8825mipiraw_drv_lock);
        #if defined(ACER_Z3)
        OV8825SetFlipMirror(IMAGE_NORMAL/*sensor_config_data->SensorImageMirror*/);
        #else
	OV8825SetFlipMirror(IMAGE_HV_MIRROR/*sensor_config_data->SensorImageMirror*/);
        #endif
