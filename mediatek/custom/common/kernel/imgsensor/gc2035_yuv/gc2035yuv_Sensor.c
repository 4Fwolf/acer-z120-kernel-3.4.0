...
static void GC2035_Sensor_Init(void)
{
	...
	GC2035_write_cmos_sensor(0x04, 0xc8);  
	GC2035_write_cmos_sensor(0xfe, 0x00);  
	...
	GC2035_write_cmos_sensor(0x1f, 0x0f);  
	...
	GC2035_write_cmos_sensor(0xfe, 0x01);  
	GC2035_write_cmos_sensor(0x09, 0x00);  
	...
	GC2035_write_cmos_sensor(0x08, 0x4f);  
	GC2035_write_cmos_sensor(0xfe, 0x01);  
	...
	GC2035_write_cmos_sensor(0x87, 0x80);  
	...
	GC2035_write_cmos_sensor(0x90, 0x6c);  
	GC2035_write_cmos_sensor(0x97, 0x48);  
...
#if 1	//gc2035 Alight lsc reg setting list
    GC2035_write_cmos_sensor(0xfe,	0x01);
    GC2035_write_cmos_sensor(0xc2,	0x0e);
    GC2035_write_cmos_sensor(0xc3,	0x0e);
    GC2035_write_cmos_sensor(0xc4,	0x07);
    GC2035_write_cmos_sensor(0xc8,	0x1a);
    GC2035_write_cmos_sensor(0xc9,	0x0c);
    GC2035_write_cmos_sensor(0xca,	0x08);
    GC2035_write_cmos_sensor(0xbc,	0x1b);
    GC2035_write_cmos_sensor(0xbd,	0x15);
    GC2035_write_cmos_sensor(0xbe,	0x00);
    GC2035_write_cmos_sensor(0xb6,	0x24);
    GC2035_write_cmos_sensor(0xb7,	0x16);
    GC2035_write_cmos_sensor(0xb8,	0x0c);
    GC2035_write_cmos_sensor(0xc5,	0x00);
    GC2035_write_cmos_sensor(0xc6,	0x00);
    GC2035_write_cmos_sensor(0xc7,	0x07);
    ...
    GC2035_write_cmos_sensor(0xc0,	0x06);
    GC2035_write_cmos_sensor(0xc1,	0x11);
    GC2035_write_cmos_sensor(0xb9,	0x15);
    GC2035_write_cmos_sensor(0xba,	0x10);
    GC2035_write_cmos_sensor(0xbb,	0x17);
    GC2035_write_cmos_sensor(0xaa,	0x12);
    GC2035_write_cmos_sensor(0xab,	0x0d);
    GC2035_write_cmos_sensor(0xac,	0x09);
    GC2035_write_cmos_sensor(0xad,	0x0f);
    GC2035_write_cmos_sensor(0xae,	0x09);
    GC2035_write_cmos_sensor(0xaf,	0x0a);
    GC2035_write_cmos_sensor(0xb0,	0x11);
    GC2035_write_cmos_sensor(0xb1,	0x08);
    GC2035_write_cmos_sensor(0xb2,	0x09);
    GC2035_write_cmos_sensor(0xb3,	0x10);
    GC2035_write_cmos_sensor(0xb4,	0x06);
    GC2035_write_cmos_sensor(0xb5,	0x06);
    GC2035_write_cmos_sensor(0xd0,	0x00);
    GC2035_write_cmos_sensor(0xd2,	0x0b);
    ...
    GC2035_write_cmos_sensor(0xde,	0x1f);
    GC2035_write_cmos_sensor(0xdf,	0x13);
    GC2035_write_cmos_sensor(0xd4,	0x00);
    GC2035_write_cmos_sensor(0xd6,	0x22);
    GC2035_write_cmos_sensor(0xd7,	0x1d);
	...
	GC2035_write_cmos_sensor(0x4e, 0x00);  
	GC2035_write_cmos_sensor(0x4e, 0x00);  
	GC2035_write_cmos_sensor(0x4e, 0x00); //80 
	GC2035_write_cmos_sensor(0x4e, 0x00);  
	GC2035_write_cmos_sensor(0x4e, 0x00);  
	GC2035_write_cmos_sensor(0x4e, 0x00);  
	GC2035_write_cmos_sensor(0x4e, 0x00);  
...
#if 1
    //add////Light Mode:0
    ////gc2035 awb register list - gc sensor test software
    ////Record date: 2012-08-06 16:20:24
    GC2035_write_cmos_sensor(0xfe,  0x01);                                
    GC2035_write_cmos_sensor(0x4f,  0x00);                                
    GC2035_write_cmos_sensor(0x4d,  0x25);                                
    GC2035_write_cmos_sensor(0x4e,  0x02);//7000k                         
    GC2035_write_cmos_sensor(0x4d,  0x33);                                
    GC2035_write_cmos_sensor(0x4e,  0x00);//04/opt&green                  
    GC2035_write_cmos_sensor(0x4e,  0x04);//opt                            
    GC2035_write_cmos_sensor(0x4e,  0x02);//02//SPL D65                   
    GC2035_write_cmos_sensor(0x4e,  0x00);//02//SPL D65&blue              
    GC2035_write_cmos_sensor(0x4d,  0x43);                                
    GC2035_write_cmos_sensor(0x4e,  0x08);//08//spl cwf&skin              
    GC2035_write_cmos_sensor(0x4e,  0x02);//outdoor am                    
    GC2035_write_cmos_sensor(0x4e,  0x02);//outdoor  am                    
    GC2035_write_cmos_sensor(0x4e,  0x00);//                              
    GC2035_write_cmos_sensor(0x4d,  0x53);                                
    GC2035_write_cmos_sensor(0x4e,  0x00);//10//spl tl84&skin             
    GC2035_write_cmos_sensor(0x4d,  0x62);                                
    GC2035_write_cmos_sensor(0x4e,  0x20);//spl a                         
    GC2035_write_cmos_sensor(0x4e,  0x00);//10//10//spl tl84              
    GC2035_write_cmos_sensor(0x4d,  0x72);                                
    GC2035_write_cmos_sensor(0x4e,  0x20);//SPL a                         
    GC2035_write_cmos_sensor(0x4d,  0x82);                                
    GC2035_write_cmos_sensor(0x4e,  0x00);//20//40//SPL H                 
    GC2035_write_cmos_sensor(0x4d,  0x92);                                
    GC2035_write_cmos_sensor(0x4e,  0x00);//40//SPL H                     
    GC2035_write_cmos_sensor(0x4f,  0x01);                                
    GC2035_write_cmos_sensor(0x56,  0x22);                                
    GC2035_write_cmos_sensor(0x5b,  0x04);                                
    GC2035_write_cmos_sensor(0x89,  0x73);                                
    GC2035_write_cmos_sensor(0x8d,  0x80);                                
    GC2035_write_cmos_sensor(0xfe,  0x00);                                
    GC2035_write_cmos_sensor(0xec,  0x06);                                
    GC2035_write_cmos_sensor(0xed,  0x06);                                
    GC2035_write_cmos_sensor(0xee,  0x62);                                
    GC2035_write_cmos_sensor(0xef,  0x92);                                    
#endif	
	GC2035_write_cmos_sensor(0xfe, 0x00);  
	...
	GC2035_write_cmos_sensor(0xfe, 0x02);  
	GC2035_write_cmos_sensor(0xa5, 0x50); 
	GC2035_write_cmos_sensor(0xa2, 0xb0);  
	GC2035_write_cmos_sensor(0xa6, 0x50);  
	GC2035_write_cmos_sensor(0xa7, 0x30);  
	GC2035_write_cmos_sensor(0xab, 0x31);  
	GC2035_write_cmos_sensor(0x88, 0x15);  
	GC2035_write_cmos_sensor(0xa9, 0x6c);  
	GC2035_write_cmos_sensor(0xb0, 0x55);  
	GC2035_write_cmos_sensor(0xb3, 0x70);  
	GC2035_write_cmos_sensor(0x8c, 0xf6);  
	GC2035_write_cmos_sensor(0x89, 0x03);  
	GC2035_write_cmos_sensor(0xde, 0xb6);  
	GC2035_write_cmos_sensor(0x38, 0x08);  
	GC2035_write_cmos_sensor(0x39, 0x50);  
	GC2035_write_cmos_sensor(0xfe, 0x00);  
	GC2035_write_cmos_sensor(0x81, 0x26);  
	GC2035_write_cmos_sensor(0x87, 0x80);  
	GC2035_write_cmos_sensor(0xfe, 0x02);  
	...
	GC2035_write_cmos_sensor(0xd1, 0x3c);  
	GC2035_write_cmos_sensor(0xd2, 0x3c);  
	GC2035_write_cmos_sensor(0xdd, 0x38);  
	GC2035_write_cmos_sensor(0xfe, 0x00);  
	GC2035_write_cmos_sensor(0xfe, 0x02);  
	...
	GC2035_write_cmos_sensor(0x02, 0x00);
...
BOOL GC2035_set_param_banding(UINT16 para)
{
    switch (para)
    {
		...
		GC2035_write_cmos_sensor(0x2c,0xc8);
		GC2035_write_cmos_sensor(0x2d,0x07);//6e8//level3
		GC2035_write_cmos_sensor(0x2e,0x3a);
		...
		GC2035_write_cmos_sensor(0x2d,0x07);//level3
...
BOOL GC2035_set_param_exposure(UINT16 para)
{
	switch (para)
	{
		...
		case AE_EV_COMP_00:
			GC2035_SET_PAGE1;
			GC2035_write_cmos_sensor(0x13,0x74);
			GC2035_SET_PAGE0;
		break;
		case AE_EV_COMP_03:
			GC2035_SET_PAGE1;
