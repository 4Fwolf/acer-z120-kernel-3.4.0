...
typedef struct
{
	...
	#define S5K4E1GA_IMAGE_SENSOR_FULL_WIDTH					(2592-24)//2568
	#define S5K4E1GA_IMAGE_SENSOR_FULL_HEIGHT					(1944-18)//1926

	/* SENSOR PV SIZE */
	#define S5K4E1GA_IMAGE_SENSOR_PV_WIDTH						(1280)//(1280-4) 2560
	#define S5K4E1GA_IMAGE_SENSOR_PV_HEIGHT						(960)//(960-4)    1920
...
#define S5K4E1GA_WRITE_ID 	(0x20)	//(0x20)   //(0x6E)
#define S5K4E1GA_READ_ID	(0x21)

// SENSOR CHIP VERSION

//#define S5K4E1GA_SENSOR_ID            S5K4E1GA_SENSOR_ID

#define S5K4E1GA_PAGE_SETTING_REG    (0xFF)
...
UINT32 S5K4E1GAGetInfo(MSDK_SCENARIO_ID_ENUM ScenarioId, MSDK_SENSOR_INFO_STRUCT *pSensorInfo, MSDK_SENSOR_CONFIG_STRUCT *pSensorConfigData);
UINT32 S5K4E1GAControl(MSDK_SCENARIO_ID_ENUM ScenarioId, MSDK_SENSOR_EXPOSURE_WINDOW_STRUCT *pImageWindow, MSDK_SENSOR_CONFIG_STRUCT *pSensorConfigData);
UINT32 S5K4E1GAFeatureControl(MSDK_SENSOR_FEATURE_ENUM FeatureId, UINT8 *pFeaturePara,UINT32 *pFeatureParaLen);
