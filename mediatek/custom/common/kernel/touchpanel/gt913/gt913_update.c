...
static u8 gup_enter_upadte_judge(st_fw_head *fw_head)
{
    ...
    if ( !memcmp(fw_head->hw_info, update_msg.ic_fw_msg.hw_info, sizeof(update_msg.ic_fw_msg.hw_info)))
    {
        ...
        if ( (!memcmp(fw_head->pid, update_msg.ic_fw_msg.pid, sizeof(update_msg.ic_fw_msg.pid)))||
        	((update_msg.ic_fw_msg.pid[0] == '9')&&(update_msg.ic_fw_msg.pid[1]=='1')&&(update_msg.ic_fw_msg.pid[2] =='X' )&&(update_msg.ic_fw_msg.pid[3] =='X' )))
        {
